...
import com.mangareader.application.review.usecase.GetReviewAverageUseCase.ReviewAverage;

@ExtendWith(MockitoExtension.class)
@DisplayName("GetReviewAverageUseCase")
class GetRatingAverageUseCaseTest {
    ...
    void repassaAgregado() {
        ...
        ReviewAverage result = getRatingAverageUseCase.execute(TITLE_ID);
