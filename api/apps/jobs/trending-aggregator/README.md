# Trending Aggregator — `api/apps/jobs/trending-aggregator`
...
- PostgreSQL 17;
- MongoDB 8.0;
- infraestrutura iniciada separadamente pelo `api/apps/core`.
...
```bash
./mvnw -pl apps/jobs/trending-aggregator spring-boot:run

# Build
./mvnw -pl apps/jobs/trending-aggregator -am package -DskipTests
java -jar apps/jobs/trending-aggregator/target/trending-aggregator-0.0.1-SNAPSHOT.jar
...
./mvnw -pl apps/jobs/trending-aggregator -am test -Dtest=TrendScoreCalculatorTest,RecalculateTrendingUseCaseTest
```
