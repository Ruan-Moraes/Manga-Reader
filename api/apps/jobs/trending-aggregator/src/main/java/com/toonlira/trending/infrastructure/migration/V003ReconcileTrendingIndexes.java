package com.toonlira.trending.infrastructure.migration;
...
import com.toonlira.trending.config.TrendingProperties;
 ...
 */
@ChangeUnit(id = "V003-reconcile-trending-indexes", order = "003", author = "toonlira")
