...
class GatewayControllerTest {
    ...
    void shouldExposeCapabilitiesWithEtagOutsideTheBody() throws Exception {
        var disclosure = new CapabilitiesView.LegalDisclosure("privacy-1", "Manga Reader", "privacy@example.com",
            "https://example.com/privacy", "https://example.com/terms", "southamerica-east1", List.of("us", "us-central1"),
            3600, 3600, 7, "No training");
        when(getCapabilities.execute()).thenReturn(new CapabilitiesView("1.0", "manga-reader-alpha", job.serverTime(),
