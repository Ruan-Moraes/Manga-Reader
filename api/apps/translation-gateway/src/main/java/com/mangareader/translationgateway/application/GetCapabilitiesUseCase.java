...
import static com.mangareader.translationgateway.domain.GatewayErrorCode.CAPABILITIES_UNAVAILABLE;
...
public class GetCapabilitiesUseCase {
    ...
    public void requireEnabled() {
        ...
        if (!capabilities.enabled()) throw new GatewayException(com.mangareader.translationgateway.domain.GatewayErrorCode.GATEWAY_DISABLED, 503, true);
    }
