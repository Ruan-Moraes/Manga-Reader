package com.toonlira.application.shared.util;

/**
 * Builder para templates de email HTML padronizados.
 * <p>
 * Gera HTML com layout consistente: header roxo, corpo, footer "Toonlira".
 * Uso:
 * <pre>
...
public final class EmailTemplateBuilder {
    ...
    private static final String DEFAULT_FOOTER_TEXT = "Toonlira — Sua plataforma de mangás";
