package com.toonlira.infrastructure.security.config;
...
import com.toonlira.infrastructure.security.jwt.JwtAuthenticationFilter;
import com.toonlira.infrastructure.security.ratelimit.RateLimitFilter;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/titles").permitAll()
                        .requestMatchers(HttpMethod.GET, "/api/releases").permitAll()
