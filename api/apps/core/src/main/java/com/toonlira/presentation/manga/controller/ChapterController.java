...
import com.toonlira.application.manga.usecase.GetChapterByNumberUseCase;
import com.toonlira.application.manga.usecase.GetChaptersByTitleUseCase;
import com.toonlira.application.manga.usecase.GetReaderChapterUseCase;
import com.toonlira.presentation.manga.dto.ChapterResponse;
import com.toonlira.presentation.manga.dto.ReaderChapterResponse;
...
public class ChapterController {
    ...
    public ResponseEntity<ApiResponse<ReaderChapterResponse>> reader(@PathVariable String titleId,
        ...
        var pages = chapter.getPageItems().stream().filter(page -> "ready".equalsIgnoreCase(page.getProcessingStatus()))
                .sorted(java.util.Comparator.comparingInt(com.toonlira.domain.manga.entity.ChapterPage::getOrder))
