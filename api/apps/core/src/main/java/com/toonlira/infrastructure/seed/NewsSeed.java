...
import com.toonlira.domain.news.valueobject.NewsSlug;
import com.toonlira.domain.news.valueobject.NewsStatus;
import com.toonlira.infrastructure.persistence.mongo.mapper.NewsPersistenceMapper;
import com.toonlira.infrastructure.persistence.mongo.repository.NewsMongoRepository;
...
public class NewsSeed implements EntitySeeder {
    ...
    public void seed() {
        ...
        var authorRedacao = NewsAuthor.builder()
                .id("author-1").name("Redação Toonlira")
        ...
        var news = List.of(
                ...
                NewsItem.builder()
                        ...
                        .content(lsl(
                                List.of(
                                        "A comunidade Toonlira elegeu os 10 melhores mangás de 2025 em votação aberta que reuniu mais de 50 mil participantes.",
                                ...
                                List.of(
                                        "The Toonlira community elected the 10 best manga of 2025 in an open vote that gathered over 50 thousand participants.",
                                ...
                                List.of(
                                        "La comunidad Toonlira eligió los 10 mejores mangas de 2025 en una votación abierta que reunió a más de 50 mil participantes.",
                        ...
                        .source("Toonlira").sourceLogo("https://picsum.photos/50/50?random=403")
                ...
                NewsItem.builder()
                        ...
                        .excerpt(ls(
                                "Em entrevista ao Toonlira, o criador de Crônicas de Polaris compartilha os bastidores da obra.",
                                "In an interview with Toonlira, the creator of Polaris Chronicles shares the work's behind-the-scenes.",
                                "En entrevista con Toonlira, el creador de Crónicas de Polaris comparte los entresijos de la obra."))
                        .content(lsl(
                                List.of(
                        ...
                        .source("Toonlira").sourceLogo("https://picsum.photos/50/50?random=405")
