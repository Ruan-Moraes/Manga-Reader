package com.toonlira.domain.subscription.entity;
...
import com.toonlira.infrastructure.persistence.postgres.converter.LocalizedStringJsonConverter;
...
public class SubscriptionPlan {
    ...
    @JdbcTypeCode(SqlTypes.JSON)
    @Convert(converter = com.toonlira.infrastructure.persistence.postgres.converter.LocalizedStringListJsonConverter.class)
