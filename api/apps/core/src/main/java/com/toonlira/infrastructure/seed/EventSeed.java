...
public class EventSeed implements EntitySeeder {
    ...
    public void seed() {
        ...
        var org3 = EventOrganizer.builder().organizerId("org-3").organizerName("Toonlira")
                .organizerAvatar("https://i.pravatar.cc/100?img=42").organizerProfileLink("/profile/toonlira")
                .organizerContact("live@toonlira.com").build();
        ...
        var org5 = EventOrganizer.builder().organizerId("org-5").organizerName("Comunidade Toonlira RJ")
                .organizerAvatar("https://i.pravatar.cc/100?img=44").organizerProfileLink("/profile/toonlira-rj")
                .organizerContact("rj@toonlira.com").build();
        ...
        var live = Event.builder()
                ...
                .description(ls(
                        "Junte-se à equipe Toonlira para uma análise ao vivo dos mangás lançados em março de 2026.",
                        "Join the Toonlira team for a live review of manga released in March 2026.",
                        "Únete al equipo Toonlira para un análisis en vivo de los mangas lanzados en marzo de 2026."))
                ...
                .location(EventLocation.builder()
                        ...
                        .mapLink("https://youtube.com/@toonlira").build())
                .organizer(org3)
                .priceLabel("Gratuito")
        ...
        var meetup = Event.builder()
                .title(ls(
                        "Meetup Leitores Toonlira — Rio de Janeiro",
                        "Toonlira Readers Meetup — Rio de Janeiro",
                        "Meetup Lectores Toonlira — Río de Janeiro"))
                .subtitle(ls(
                        "Encontro informal de leitores no Rio",
                        "Informal readers' gathering in Rio",
                        "Encuentro informal de lectores en Río"))
                .description(ls(
                        "Encontro presencial para leitores da comunidade Toonlira. Traga seus volumes favoritos para trocar e discutir!",
                        "In-person gathering for Toonlira community readers. Bring your favorite volumes to swap and discuss!",
                        "Encuentro presencial para lectores de la comunidad Toonlira. ¡Trae tus volúmenes favoritos para intercambiar y discutir!"))
        ...
        var liveOnline = Event.builder()
                ...
                .type(EventType.LIVE)
                .location(EventLocation.builder()
                        .label("Discord Toonlira").address("Online")
                        .city("Online").isOnline(true)
                        .mapLink("https://discord.gg/toonlira").build())
                .organizer(org3)
                .priceLabel("Gratuito")
        ...
        var workshopOnline = Event.builder()
                ...
                .location(EventLocation.builder()
                        ...
                        .city("Online").isOnline(true)
                        .mapLink("https://zoom.us/toonlira-workshop").build())
                .organizer(org3)
                .priceLabel("R$ 39,90")
