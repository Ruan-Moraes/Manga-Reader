package com.toonlira.domain.review.entity;
...
import com.toonlira.shared.domain.vote.HasVoteCounters;
...
@CompoundIndex(name = "idx_reviews_title_user", def = "{'titleId': 1, 'userId': 1}", unique = true)
@Getter
@Setter
@NoArgsConstructor
@AllArgsConstructor
@Builder
public class Review implements HasVoteCounters {
    @Id
    private String id;
