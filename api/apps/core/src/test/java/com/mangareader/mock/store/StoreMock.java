...
public final class StoreMock {
    ...
    public static Store amazonStore() {
        Store store = Store.builder()
                ...
                .description(com.mangareader.shared.domain.i18n.LocalizedString.ofDefault("Maior loja online do mundo com vasto catalogo de mangas."))
    ...
    public static Store paniniStore() {
        Store store = Store.builder()
                ...
                .description(com.mangareader.shared.domain.i18n.LocalizedString.ofDefault("Editora oficial de diversos mangas no Brasil."))
    ...
    public static Store preOrderStore() {
        Store store = Store.builder()
                .id(STORE_3_ID)
                .name(com.mangareader.shared.domain.i18n.LocalizedString.ofDefault("Manga Import"))
                .logo("https://picsum.photos/200/60?random=s3")
                .description(com.mangareader.shared.domain.i18n.LocalizedString.ofDefault("Loja especializada em importacao de mangas japoneses."))
    ...
    public static Store outOfStockStore() {
        return Store.builder()
                .id(UUID.randomUUID())
                .name(com.mangareader.shared.domain.i18n.LocalizedString.ofDefault("Loja Fechada"))
                .description(com.mangareader.shared.domain.i18n.LocalizedString.ofDefault("Temporariamente sem estoque."))
    ...
    public static Store emptyStore() {
        return Store.builder()
                .id(UUID.randomUUID())
                .name(com.mangareader.shared.domain.i18n.LocalizedString.ofDefault("Nova Loja"))
