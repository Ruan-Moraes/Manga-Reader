...
class GroupRepositoryAdapterTest {
    ...
    void setUp() {
        ...
        groupA = Group.builder()
                .name(com.toonlira.shared.domain.i18n.LocalizedString.ofDefault("Scan One Piece"))
                .username("scan-op")
                .build();
        ...
        groupB = entityManager.persistAndFlush(
                Group.builder()
                        .name(com.toonlira.shared.domain.i18n.LocalizedString.ofDefault("Scan Naruto"))
    ...
    class Save {
        ...
        void devePersistirNovoGrupo() {
            var newGroup = Group.builder()
                    .name(com.toonlira.shared.domain.i18n.LocalizedString.ofDefault("Scan Bleach"))
        ...
        void deveAtualizarGrupo() {
            groupB.setName(com.toonlira.shared.domain.i18n.LocalizedString.ofDefault("Scan Naruto Shippuden"));
