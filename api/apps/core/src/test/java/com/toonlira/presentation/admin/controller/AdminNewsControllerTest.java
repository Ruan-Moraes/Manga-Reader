...
import com.toonlira.application.news.usecase.admin.CreateNewsUseCase;
import com.toonlira.application.news.usecase.admin.DeleteNewsUseCase;
import com.toonlira.application.news.usecase.admin.GetAdminNewsUseCase;
import com.toonlira.application.news.usecase.admin.ListAdminNewsUseCase;
import com.toonlira.application.news.usecase.admin.UpdateNewsUseCase;
import com.toonlira.application.news.usecase.admin.ChangeNewsStatusUseCase;
...
class AdminNewsControllerTest {
    ...
    private NewsItem buildNews() {
        return NewsItem.builder()
                .id("news-1")
                .title(com.toonlira.shared.domain.i18n.LocalizedString.ofDefault("Breaking News"))
                .subtitle(com.toonlira.shared.domain.i18n.LocalizedString.ofDefault("Subtitle"))
                .excerpt(com.toonlira.shared.domain.i18n.LocalizedString.ofDefault("Excerpt"))
    ...
    void deveRetornar201AoCriarNoticia() throws Exception {
        when(createNewsUseCase.execute(any(com.toonlira.application.news.usecase.admin.CreateNewsUseCase.CreateNewsCommand.class)))
    ...
    void deveRetornar200AoAtualizar() throws Exception {
        ...
        updated.setTitle(com.toonlira.shared.domain.i18n.LocalizedString.ofDefault("Updated News"));
        when(updateNewsUseCase.execute(any(com.toonlira.application.news.usecase.admin.UpdateNewsUseCase.UpdateNewsCommand.class)))
                .thenReturn(updated);
