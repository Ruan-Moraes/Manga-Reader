...
class NewsRepositoryAdapterTest {
    ...
    void setUp() {
        ...
        news1 = newsRepository.save(NewsItem.builder()
                .title(com.toonlira.shared.domain.i18n.LocalizedString.ofDefault("Novo capitulo de Naruto"))
                .subtitle(com.toonlira.shared.domain.i18n.LocalizedString.ofDefault("Lancamento surpresa"))
                .excerpt(com.toonlira.shared.domain.i18n.LocalizedString.ofDefault("O mangaka anunciou..."))
        ...
        news2 = newsRepository.save(NewsItem.builder()
                .title(com.toonlira.shared.domain.i18n.LocalizedString.ofDefault("Adaptacao anime de One Piece"))
                .subtitle(com.toonlira.shared.domain.i18n.LocalizedString.ofDefault("Netflix confirma"))
        ...
        news3 = newsRepository.save(NewsItem.builder()
                .title(com.toonlira.shared.domain.i18n.LocalizedString.ofDefault("Evento manga expo 2024"))
                .subtitle(com.toonlira.shared.domain.i18n.LocalizedString.ofDefault("Tudo sobre o evento"))
    ...
    class Save {
        ...
        void devePersistirNovaNoticiaComEmbedded() {
            var newNews = NewsItem.builder()
                    .title(com.toonlira.shared.domain.i18n.LocalizedString.ofDefault("Nova noticia teste"))
