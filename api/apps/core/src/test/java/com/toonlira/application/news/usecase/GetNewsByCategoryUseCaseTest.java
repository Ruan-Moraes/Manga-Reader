...
class GetNewsByCategoryUseCaseTest {
    ...
    void deveRetornarNoticiasFiltradas() {
        ...
        List<NewsItem> items = List.of(
                NewsItem.builder().title(com.toonlira.shared.domain.i18n.LocalizedString.ofDefault("Mercado de mangás cresce")).category(category).build(),
                NewsItem.builder().title(com.toonlira.shared.domain.i18n.LocalizedString.ofDefault("Nova editora no Brasil")).category(category).build()
        );
