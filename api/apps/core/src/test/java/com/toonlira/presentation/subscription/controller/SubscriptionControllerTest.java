package com.toonlira.presentation.subscription.controller;
...
import com.toonlira.application.subscription.usecase.CreateGiftCodeUseCase;
import com.toonlira.application.subscription.usecase.CreateSubscriptionUseCase;
import com.toonlira.application.subscription.usecase.GetMySubscriptionHistoryUseCase;
import com.toonlira.application.subscription.usecase.GetMySubscriptionUseCase;
import com.toonlira.application.subscription.usecase.GetSubscriptionPlansUseCase;
import com.toonlira.application.subscription.usecase.RedeemGiftCodeUseCase;
...
import com.toonlira.domain.subscription.valueobject.GiftCodeStatus;
...
@org.springframework.context.annotation.Import({com.toonlira.presentation.subscription.mapper.SubscriptionMapper.class, com.toonlira.presentation.shared.mapper.LocalizedMappingHelper.class, com.toonlira.shared.web.PageableWebConfig.class})
...
class SubscriptionControllerTest {
    ...
    private static SubscriptionPlan buildPlan() {
        return SubscriptionPlan.builder()
                ...
                .priceInCents(1990L)
                .description(com.toonlira.shared.domain.i18n.LocalizedString.ofDefault("Mensal"))
                .features(com.toonlira.shared.domain.i18n.LocalizedStringList.ofDefault(List.of("HD", "Offline")))
                .build();
    }
