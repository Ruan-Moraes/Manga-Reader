...
class AdminListGroupsUseCaseTest {
    ...
    void deveListarTodosSemFiltro() {
        var page = new PageImpl<>(List.of(Group.builder().name(com.toonlira.shared.domain.i18n.LocalizedString.ofDefault("Group 1")).build()));
    ...
    void deveBuscarPorNome() {
        var page = new PageImpl<>(List.of(Group.builder().name(com.toonlira.shared.domain.i18n.LocalizedString.ofDefault("Scan Team")).build()));
        Pageable pageable = PageRequest.of(0, 20);
