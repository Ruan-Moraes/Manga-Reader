package com.toonlira.mock.store;

import com.toonlira.domain.store.entity.Store;
import com.toonlira.domain.store.entity.StoreTitle;
import com.toonlira.domain.store.valueobject.StoreAvailability;
import com.toonlira.mock.title.TitleMock;
...
public final class StoreMock {
    ...
    public static Store amazonStore() {
        Store store = Store.builder()
                .id(STORE_1_ID)
                .name(com.toonlira.shared.domain.i18n.LocalizedString.ofDefault("Amazon"))
                .logo("https://picsum.photos/200/60?random=s1")
                .icon("https://picsum.photos/50/50?random=s1i")
                .description(com.toonlira.shared.domain.i18n.LocalizedString.ofDefault("Maior loja online do mundo com vasto catalogo de mangas."))
    ...
    public static Store paniniStore() {
        Store store = Store.builder()
                .id(STORE_2_ID)
                .name(com.toonlira.shared.domain.i18n.LocalizedString.ofDefault("Panini"))
                .logo("https://picsum.photos/200/60?random=s2")
                .icon("https://picsum.photos/50/50?random=s2i")
                .description(com.toonlira.shared.domain.i18n.LocalizedString.ofDefault("Editora oficial de diversos mangas no Brasil."))
    ...
    public static Store preOrderStore() {
        Store store = Store.builder()
                .id(STORE_3_ID)
                .name(com.toonlira.shared.domain.i18n.LocalizedString.ofDefault("Manga Import"))
                .logo("https://picsum.photos/200/60?random=s3")
                .description(com.toonlira.shared.domain.i18n.LocalizedString.ofDefault("Loja especializada em importacao de mangas japoneses."))
    ...
    public static Store outOfStockStore() {
        return Store.builder()
                .id(UUID.randomUUID())
                .name(com.toonlira.shared.domain.i18n.LocalizedString.ofDefault("Loja Fechada"))
                .description(com.toonlira.shared.domain.i18n.LocalizedString.ofDefault("Temporariamente sem estoque."))
    ...
    public static Store emptyStore() {
        return Store.builder()
                .id(UUID.randomUUID())
                .name(com.toonlira.shared.domain.i18n.LocalizedString.ofDefault("Nova Loja"))
