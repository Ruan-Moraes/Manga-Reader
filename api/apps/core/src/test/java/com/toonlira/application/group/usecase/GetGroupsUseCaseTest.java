...
class GetGroupsUseCaseTest {
    ...
    void deveRetornarPaginaComGrupos() {
        ...
        List<Group> groups = List.of(
                Group.builder().name(com.toonlira.shared.domain.i18n.LocalizedString.ofDefault("Grupo A")).username("grupo-a").build(),
                Group.builder().name(com.toonlira.shared.domain.i18n.LocalizedString.ofDefault("Grupo B")).username("grupo-b").build()
        );
