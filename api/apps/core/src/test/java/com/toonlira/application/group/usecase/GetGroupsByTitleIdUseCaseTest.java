...
class GetGroupsByTitleIdUseCaseTest {
    ...
    void deveRetornarPaginaDeGruposDoTitulo() {
        ...
        List<Group> groups = List.of(
                Group.builder().name(com.toonlira.shared.domain.i18n.LocalizedString.ofDefault("Scan A")).username("scan-a").build(),
                Group.builder().name(com.toonlira.shared.domain.i18n.LocalizedString.ofDefault("Scan B")).username("scan-b").build()
        );
