...
class GetTitlesUseCaseTest {
    ...
    void deveRetornarPaginaDeTitulos() {
        ...
        List<Title> titles = List.of(
                Title.builder().id("1").name(com.toonlira.shared.domain.i18n.LocalizedString.ofDefault("Naruto")).build(),
                Title.builder().id("2").name(com.toonlira.shared.domain.i18n.LocalizedString.ofDefault("One Piece")).build()
        );
