package com.toonlira.presentation.news.controller;
...
import com.toonlira.application.news.usecase.GetNewsByCategoryUseCase;
import com.toonlira.application.news.usecase.GetNewsByIdUseCase;
import com.toonlira.application.news.usecase.GetNewsUseCase;
import com.toonlira.application.news.usecase.GetRelatedNewsUseCase;
import com.toonlira.application.news.usecase.SearchNewsUseCase;
...
@org.springframework.context.annotation.Import({com.toonlira.presentation.news.mapper.NewsMapper.class, com.toonlira.presentation.shared.mapper.LocalizedMappingHelper.class, com.toonlira.shared.web.PageableWebConfig.class})
...
class NewsControllerTest {
    ...
    void stubLocaleResolver() {
        ...
        org.mockito.Mockito.when(localeResolver.resolve(org.mockito.ArgumentMatchers.any(com.toonlira.shared.domain.i18n.LocalizedStringList.class)))
                .thenAnswer(inv -> {
                    com.toonlira.shared.domain.i18n.LocalizedStringList ls = inv.getArgument(0);
    ...
    @MockitoBean
    private com.toonlira.application.label.service.DomainLabelService domainLabelService;

    private NewsItem buildNews(String id, String title) {
        return NewsItem.builder()
                .id(id)
                .title(com.toonlira.shared.domain.i18n.LocalizedString.ofDefault(title))
    ...
    class GetAll {
        ...
        void deveRetornar200ComNoticias() throws Exception {
            ...
            when(getNewsUseCase.execute(org.mockito.ArgumentMatchers.isNull(), org.mockito.ArgumentMatchers.isNull(),
                    eq(com.toonlira.domain.news.valueobject.NewsPeriod.ALL), any(Pageable.class)))
