package com.toonlira.presentation.event.controller;
...
import com.toonlira.application.event.usecase.GetEventByIdUseCase;
import com.toonlira.application.event.usecase.GetEventsByStatusUseCase;
import com.toonlira.application.event.usecase.GetEventsUseCase;
...
@org.springframework.context.annotation.Import({com.toonlira.presentation.event.mapper.EventMapper.class, com.toonlira.presentation.shared.mapper.LocalizedMappingHelper.class, com.toonlira.shared.web.PageableWebConfig.class})
...
class EventControllerTest {
    ...
    private Event buildEvent() {
        return Event.builder()
                .id(UUID.randomUUID())
                .title(com.toonlira.shared.domain.i18n.LocalizedString.ofDefault("Anime Friends 2026"))
    ...
    class GetById {
        ...
        void deveRetornar200() throws Exception {
            ...
            var event = Event.builder()
                    .id(eventId).title(com.toonlira.shared.domain.i18n.LocalizedString.ofDefault("CCXP 2026"))
