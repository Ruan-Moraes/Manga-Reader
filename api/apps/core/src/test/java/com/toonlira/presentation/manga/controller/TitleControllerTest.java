...
@org.springframework.context.annotation.Import({com.toonlira.presentation.manga.mapper.TitleMapper.class, com.toonlira.presentation.shared.mapper.LocalizedMappingHelper.class, com.toonlira.shared.web.PageableWebConfig.class})
...
class TitleControllerTest {
    ...
    @MockitoBean
    private com.toonlira.application.manga.port.TitleRatingAggregateReadPort ratingAggregateReadPort;

    @MockitoBean
    private com.toonlira.application.manga.service.GenreVocabulary genreVocabulary;

    @MockitoBean
    private com.toonlira.application.author.port.TitleAuthorRepositoryPort titleAuthorRepository;

    @MockitoBean
    private com.toonlira.application.publisher.port.TitlePublisherRepositoryPort titlePublisherRepository;

    @MockitoBean
    private com.toonlira.application.manga.service.TitleAssociationReader titleAssociationReader;
    ...
    private Title buildTitle(String id) {
        return Title.builder()
                .id(id)
                .name(com.toonlira.shared.domain.i18n.LocalizedString.ofDefault("Solo Leveling"))
                .type("Manhwa")
                .cover("cover.png")
                .synopsis(com.toonlira.shared.domain.i18n.LocalizedString.ofDefault("Um caçador fraco se torna o mais forte"))
