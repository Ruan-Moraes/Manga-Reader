...
class GetTitlesByGenreUseCaseTest {
    ...
    void deveRetornarTitulosFiltradosPorGenero() {
        ...
        List<Title> titles = List.of(
                Title.builder().id("1").name(com.toonlira.shared.domain.i18n.LocalizedString.ofDefault("Naruto")).genres(List.of("Ação", "Aventura")).build(),
                Title.builder().id("2").name(com.toonlira.shared.domain.i18n.LocalizedString.ofDefault("Dragon Ball")).genres(List.of("Ação", "Comédia")).build()
        );
