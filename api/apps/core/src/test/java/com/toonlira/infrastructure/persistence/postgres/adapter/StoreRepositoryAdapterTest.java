...
class StoreRepositoryAdapterTest {
    ...
    void setUp() {
        storeA = entityManager.persistAndFlush(
                Store.builder()
                        .name(com.toonlira.shared.domain.i18n.LocalizedString.ofDefault("Amazon Manga"))
        ...
        storeB = entityManager.persistAndFlush(
                Store.builder()
                        .name(com.toonlira.shared.domain.i18n.LocalizedString.ofDefault("Manga Store JP"))
    ...
    class Save {
        ...
        void devePersistirNovaLoja() {
            var newStore = Store.builder()
                    .name(com.toonlira.shared.domain.i18n.LocalizedString.ofDefault("Bookwalker"))
        ...
        void deveAtualizarLoja() {
            storeB.setName(com.toonlira.shared.domain.i18n.LocalizedString.ofDefault("Manga Store Japan"));
