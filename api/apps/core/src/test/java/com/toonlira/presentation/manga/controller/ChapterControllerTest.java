...
class ChapterControllerTest {
    ...
    @MockitoBean
    private com.toonlira.application.manga.usecase.GetReaderChapterUseCase getReaderChapterUseCase;

    @MockitoBean
    private TokenPort tokenPort;

    @MockitoBean
    private com.toonlira.presentation.shared.mapper.LocalizedMappingHelper i18n;
