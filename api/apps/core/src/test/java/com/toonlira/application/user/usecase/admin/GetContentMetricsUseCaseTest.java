...
class GetContentMetricsUseCaseTest {
    ...
    void deveRetornarTopTitulos() {
        Title title = Title.builder()
                .id("t1")
                .name(com.toonlira.shared.domain.i18n.LocalizedString.ofDefault("Top Manga"))
                .cover("cover.jpg")
                .type("MANGA")
                .build();
        ...
        when(localeResolutionService.resolve(any(com.toonlira.shared.domain.i18n.LocalizedString.class))).thenReturn("Top Manga");
