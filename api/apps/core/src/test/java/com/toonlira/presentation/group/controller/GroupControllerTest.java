package com.toonlira.presentation.group.controller;
...
import com.toonlira.application.group.usecase.AddWorkToGroupUseCase;
import com.toonlira.application.group.usecase.CreateGroupUseCase;
import com.toonlira.application.group.usecase.GetGroupByIdUseCase;
import com.toonlira.application.group.usecase.GetGroupByUsernameUseCase;
import com.toonlira.application.group.usecase.GetGroupsByTitleIdUseCase;
import com.toonlira.application.group.usecase.GetGroupsUseCase;
import com.toonlira.application.group.usecase.GetGroupWorksUseCase;
import com.toonlira.application.group.usecase.JoinGroupUseCase;
import com.toonlira.application.group.usecase.LeaveGroupUseCase;
import com.toonlira.application.group.usecase.RemoveWorkFromGroupUseCase;
import com.toonlira.application.group.usecase.SupportGroupUseCase;
import com.toonlira.application.group.usecase.UnsupportGroupUseCase;
import com.toonlira.application.group.usecase.UpdateGroupUseCase;
import com.toonlira.domain.group.entity.Group;
import com.toonlira.domain.group.entity.GroupWork;
import com.toonlira.domain.group.valueobject.GroupStatus;
import com.toonlira.domain.group.valueobject.GroupWorkStatus;
import com.toonlira.shared.exception.ResourceNotFoundException;
import com.toonlira.application.auth.port.TokenPort;

@WebMvcTest(GroupController.class)
@org.springframework.context.annotation.Import({com.toonlira.presentation.group.mapper.GroupMapper.class, com.toonlira.presentation.shared.mapper.LocalizedMappingHelper.class, com.toonlira.shared.web.PageableWebConfig.class})
...
class GroupControllerTest {
    ...
    @MockitoBean
    private com.toonlira.shared.application.i18n.LocaleResolutionService localeResolver;
    @org.junit.jupiter.api.BeforeEach
    void stubLocaleResolver() {
        org.mockito.Mockito.when(localeResolver.resolve(org.mockito.ArgumentMatchers.any(com.toonlira.shared.domain.i18n.LocalizedString.class)))
                .thenAnswer(inv -> {
                    com.toonlira.shared.domain.i18n.LocalizedString ls = inv.getArgument(0);
    ...
    private Group buildGroup(UUID id) {
        return Group.builder()
                .id(id)
                .name(com.toonlira.shared.domain.i18n.LocalizedString.ofDefault("Scan Traduções"))
                .username("scan-traducoes")
                .description(com.toonlira.shared.domain.i18n.LocalizedString.ofDefault("Grupo de tradução"))
                .logo("logo.png")
                .banner("banner.png")
    ...
    class GetByTitleId {
        ...
        void deveRetornarPaginaVazia() throws Exception {
            ...
            org.springframework.data.domain.Page<com.toonlira.domain.group.entity.Group> emptyPage =
