...
class TitleTest {
    ...
    void shouldSetAllFieldsViaBuilder() {
        Title title = Title.builder()
                .id("abc123")
                .type("manga")
                .name(com.toonlira.shared.domain.i18n.LocalizedString.ofDefault("One Piece"))
                .cover("https://example.com/cover.jpg")
                .synopsis(com.toonlira.shared.domain.i18n.LocalizedString.ofDefault("Aventura pirata épica"))
    ...
    void shouldOverrideDefaultGenresInBuilder() {
        ...
        Title title = Title.builder()
                .name(com.toonlira.shared.domain.i18n.LocalizedString.ofDefault("Fruits Basket"))
                .genres(genres)
                .build();
    ...
    void shouldInitializeAdultAsFalse() {
        Title title = Title.builder().name(com.toonlira.shared.domain.i18n.LocalizedString.ofDefault("Test")).build();
    ...
    void shouldSetAdultViaBuilder() {
        Title title = Title.builder().name(com.toonlira.shared.domain.i18n.LocalizedString.ofDefault("Test")).adult(true).build();
    ...
    void shouldSetStatusViaBuilder() {
        Title title = Title.builder().name(com.toonlira.shared.domain.i18n.LocalizedString.ofDefault("Test")).status("ONGOING").build();
    ...
    void shouldSupportMutationViaSetters() {
        Title title = Title.builder()
                .name(com.toonlira.shared.domain.i18n.LocalizedString.ofDefault("Original"))
                .build();

        title.setName(com.toonlira.shared.domain.i18n.LocalizedString.ofDefault("Atualizado"));
