...
class UserControllerTest {
    ...
    @MockitoBean
    private com.toonlira.application.user.usecase.UpdateLanguagePreferencesUseCase updateLanguagePreferencesUseCase;

    @MockitoBean
    private com.toonlira.application.user.usecase.UpdateFavoriteGenresUseCase updateFavoriteGenresUseCase;

    @MockitoBean
    private GetUserSettingsUseCase getUserSettingsUseCase;

    @MockitoBean
    private com.toonlira.application.user.usecase.UpdateUserSettingsUseCase updateUserSettingsUseCase;
    ...
    @MockitoBean
    private com.toonlira.application.user.usecase.GetUserGroupsUseCase getUserGroupsUseCase;

    @MockitoBean
    private com.toonlira.presentation.user.mapper.UserGroupMapper userGroupMapper;

    @MockitoBean
    private com.toonlira.application.user.usecase.DeleteAccountUseCase deleteAccountUseCase;

    @MockitoBean
    private com.toonlira.application.user.usecase.ClearTrackedHistoryUseCase clearTrackedHistoryUseCase;
    ...
    class GetMyGroups {
        ...
        void deveRetornar200() throws Exception {
            var linked = new com.toonlira.presentation.user.dto.UserGroupsResponse.UserGroupItemResponse(
                    UUID.randomUUID().toString(), "Scan One Piece", "scan-op", null, "Tradutor(a)", 5L);
            var available = new com.toonlira.presentation.user.dto.UserGroupsResponse.UserGroupItemResponse(
                    UUID.randomUUID().toString(), "Scan Naruto", "scan-naruto", null, null, 3L);
            var response = new com.toonlira.presentation.user.dto.UserGroupsResponse(
                    List.of(linked), List.of(available));

            when(getUserGroupsUseCase.execute(USER_ID)).thenReturn(
                    new com.toonlira.application.user.usecase.GetUserGroupsUseCase.UserGroups(List.of(), List.of()));
