package com.toonlira.mock.title;
...
public final class TitleMock {
    ...
    public static Title reinoDeAco() {
        return Title.builder()
                .id(TITLE_1_ID)
                .type("Manga")
                .name(com.toonlira.shared.domain.i18n.LocalizedString.ofDefault("Reino de Aco"))
                .cover("https://picsum.photos/300/450?random=101")
                .synopsis(com.toonlira.shared.domain.i18n.LocalizedString.ofDefault("Em um mundo onde armaduras vivas dominam os campos de batalha, "
    ...
    public static Title laminaDoAmanha() {
        return Title.builder()
                .id(TITLE_2_ID)
                .type("Manhwa")
                .name(com.toonlira.shared.domain.i18n.LocalizedString.ofDefault("Lamina do Amanha"))
                .cover("https://picsum.photos/300/450?random=102")
                .synopsis(com.toonlira.shared.domain.i18n.LocalizedString.ofDefault("Quando a tecnologia e a espada se encontram, uma guerreira do futuro "
    ...
    public static Title floresDeNeon() {
        return Title.builder()
                .id(TITLE_3_ID)
                .type("Manhua")
                .name(com.toonlira.shared.domain.i18n.LocalizedString.ofDefault("Flores de Neon"))
                .cover("https://picsum.photos/300/450?random=103")
                .synopsis(com.toonlira.shared.domain.i18n.LocalizedString.ofDefault("Numa metrópole futurista iluminada por neon, uma florista descobre "
    ...
    public static Title cronicasDePolaris() {
        return Title.builder()
                .id(TITLE_4_ID)
                .type("Manga")
                .name(com.toonlira.shared.domain.i18n.LocalizedString.ofDefault("Cronicas de Polaris"))
                .cover("https://picsum.photos/300/450?random=104")
                .synopsis(com.toonlira.shared.domain.i18n.LocalizedString.ofDefault("Exploradores cruzam um oceano desconhecido em busca de uma terra lendaria "
    ...
    public static Title ventoCortante() {
        return Title.builder()
                .id(TITLE_5_ID)
                .type("Manga")
                .name(com.toonlira.shared.domain.i18n.LocalizedString.ofDefault("Vento Cortante"))
                .cover("https://picsum.photos/300/450?random=105")
                .synopsis(com.toonlira.shared.domain.i18n.LocalizedString.ofDefault("Um espadachim cego viaja pelo Japao feudal em busca de redencao."))
    ...
    public static Title guardiaoCelestial() {
        return Title.builder()
                .id(TITLE_6_ID)
                .type("Manhwa")
                .name(com.toonlira.shared.domain.i18n.LocalizedString.ofDefault("Guardiao Celestial"))
                .cover("https://picsum.photos/300/450?random=106")
                .synopsis(com.toonlira.shared.domain.i18n.LocalizedString.ofDefault("Um anjo caido protege a humanidade enquanto busca recuperar suas asas."))
    ...
    public static Title coracaoDePorcelana() {
        return Title.builder()
                .id(TITLE_7_ID)
                .type("Manhua")
                .name(com.toonlira.shared.domain.i18n.LocalizedString.ofDefault("Coracao de Porcelana"))
                .cover("https://picsum.photos/300/450?random=107")
                .synopsis(com.toonlira.shared.domain.i18n.LocalizedString.ofDefault("Uma artesã de porcelana descobre que suas criações ganham vida a noite."))
    ...
    public static Title protocoloZero() {
        return Title.builder()
                .id(TITLE_8_ID)
                .type("Manga")
                .name(com.toonlira.shared.domain.i18n.LocalizedString.ofDefault("Protocolo Zero"))
                .cover("https://picsum.photos/300/450?random=108")
                .synopsis(com.toonlira.shared.domain.i18n.LocalizedString.ofDefault("Numa sociedade controlada por IA, um hacker descobre uma falha no sistema "
    ...
    public static Title withNoChapters() {
        return Title.builder()
                .id("title-empty")
                .type("Manga")
                .name(com.toonlira.shared.domain.i18n.LocalizedString.ofDefault("Titulo Sem Capitulos"))
                .cover("https://picsum.photos/300/450?random=200")
                .synopsis(com.toonlira.shared.domain.i18n.LocalizedString.ofDefault("Um titulo recem-criado sem capitulos publicados."))
    ...
    public static Title withNoRatings() {
        return Title.builder()
                .id("title-no-ratings")
                .type("Manhwa")
                .name(com.toonlira.shared.domain.i18n.LocalizedString.ofDefault("Obra Nova Sem Avaliacoes"))
                .cover("https://picsum.photos/300/450?random=201")
                .synopsis(com.toonlira.shared.domain.i18n.LocalizedString.ofDefault("Lancamento recente que ainda nao recebeu avaliacoes."))
    ...
    public static Title withAllGenres() {
        return Title.builder()
                .id("title-all-genres")
                .type("Manga")
                .name(com.toonlira.shared.domain.i18n.LocalizedString.ofDefault("Obra Multi-genero"))
                .cover("https://picsum.photos/300/450?random=202")
                .synopsis(com.toonlira.shared.domain.i18n.LocalizedString.ofDefault("Uma obra experimental que mistura todos os generos."))
    ...
    public static Title withId(String id) {
        return Title.builder()
                .id(id)
                .type("Manga")
                .name(com.toonlira.shared.domain.i18n.LocalizedString.ofDefault("Title " + id))
                .synopsis(com.toonlira.shared.domain.i18n.LocalizedString.ofDefault("Synopsis for " + id))
                .genres(new ArrayList<>(List.of("Acao")))
                .popularity("50")
                .author("Author " + id)
                .build();
