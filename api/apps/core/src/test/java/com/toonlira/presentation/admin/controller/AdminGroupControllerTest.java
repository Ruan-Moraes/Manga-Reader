...
import com.toonlira.application.group.usecase.admin.AdminChangeGroupMemberRoleUseCase;
import com.toonlira.application.group.usecase.admin.AdminGetGroupDetailsUseCase;
import com.toonlira.application.group.usecase.admin.AdminListGroupsUseCase;
import com.toonlira.application.group.usecase.admin.AdminRemoveGroupMemberUseCase;
...
class AdminGroupControllerTest {
    ...
    @MockitoBean
    private com.toonlira.application.group.usecase.admin.UpdateAdminGroupUseCase updateAdminGroupUseCase;
    ...
    private Group buildGroup() {
        return Group.builder()
                .id(GROUP_ID)
                .name(com.toonlira.shared.domain.i18n.LocalizedString.ofDefault("Scan Group"))
                .username("scangroup")
                .logo("logo.png")
                .description(com.toonlira.shared.domain.i18n.LocalizedString.ofDefault("A scan group"))
    ...
    void deveRetornar200AoAtualizarGrupo() throws Exception {
        ...
        updated.setName(com.toonlira.shared.domain.i18n.LocalizedString.ofDefault("Updated Group"));
        when(updateAdminGroupUseCase.execute(any(
                com.toonlira.application.group.usecase.admin.UpdateAdminGroupUseCase.UpdateAdminGroupInput.class
        ))).thenReturn(updated);
