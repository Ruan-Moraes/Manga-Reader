...
class RecordViewHistoryUseCaseTest {
    ...
    @Mock
    private com.toonlira.shared.application.i18n.LocaleResolutionService localeResolutionService;
    ...
    class NovaEntrada {
        ...
        void deveCriarNovaEntrada() {
            ...
            when(titleRepository.findById(TITLE_ID)).thenReturn(Optional.of(
                    Title.builder().id(TITLE_ID).name(com.toonlira.shared.domain.i18n.LocalizedString.ofDefault("Solo Leveling")).cover("cover.jpg").build()));
            when(localeResolutionService.resolve(any(com.toonlira.shared.domain.i18n.LocalizedString.class))).thenReturn("Solo Leveling");
        ...
        void deveRecarregarQuandoDuplicateKey() {
            stubUser(VisibilitySetting.PUBLIC);
            when(titleRepository.findById(TITLE_ID)).thenReturn(Optional.of(
                    Title.builder().id(TITLE_ID).name(com.toonlira.shared.domain.i18n.LocalizedString.ofDefault("Solo Leveling")).build()));
