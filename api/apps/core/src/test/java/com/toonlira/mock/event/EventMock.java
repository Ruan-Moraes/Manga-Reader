package com.toonlira.mock.event;

import com.toonlira.domain.event.entity.Event;
import com.toonlira.domain.event.entity.EventParticipant;
import com.toonlira.domain.event.entity.EventTicket;
import com.toonlira.domain.event.valueobject.*;
...
public final class EventMock {
    ...
    public static EventOrganizer mainOrganizer() {
        return EventOrganizer.builder()
                ...
                .organizerContact("eventos@toonlira.com")
                .build();
    }
    ...
    public static Event upcomingPresential() {
        Event event = Event.builder()
                .id(EVENT_1_ID)
                .title(com.toonlira.shared.domain.i18n.LocalizedString.ofDefault("Manga Fest 2026"))
                .subtitle(com.toonlira.shared.domain.i18n.LocalizedString.ofDefault("O maior evento de manga do Brasil"))
                .description(com.toonlira.shared.domain.i18n.LocalizedString.ofDefault("Tres dias de paineis, cosplay, sessoes de autografos e lancamentos exclusivos."))
    ...
    public static Event ongoingOnline() {
        Event event = Event.builder()
                .id(EVENT_2_ID)
                .title(com.toonlira.shared.domain.i18n.LocalizedString.ofDefault("Maratona de Leitura Online"))
                .subtitle(com.toonlira.shared.domain.i18n.LocalizedString.ofDefault("24 horas de leitura coletiva"))
                .description(com.toonlira.shared.domain.i18n.LocalizedString.ofDefault("Leia junto com a comunidade durante 24 horas. Premios para quem ler mais capitulos."))
    ...
    public static Event pastEvent() {
        Event event = Event.builder()
                .id(EVENT_3_ID)
                .title(com.toonlira.shared.domain.i18n.LocalizedString.ofDefault("Workshop de Desenho Manga"))
                .subtitle(com.toonlira.shared.domain.i18n.LocalizedString.ofDefault("Aprenda tecnicas basicas de desenho manga"))
                .description(com.toonlira.shared.domain.i18n.LocalizedString.ofDefault("Workshop presencial com artistas profissionais."))
    ...
    public static Event cancelledEvent() {
        return Event.builder()
                .id(EVENT_4_ID)
                .title(com.toonlira.shared.domain.i18n.LocalizedString.ofDefault("Encontro de Colecionadores"))
                .description(com.toonlira.shared.domain.i18n.LocalizedString.ofDefault("Cancelado por falta de inscricoes."))
