...
import com.toonlira.infrastructure.persistence.mongo.adapter.TrendingReadAdapter.MetricsDocument;
import com.toonlira.infrastructure.persistence.mongo.adapter.TrendingReadAdapter.ScoreDocument;
import com.toonlira.infrastructure.persistence.mongo.adapter.TrendingReadAdapter.SnapshotDocument;
...
class TrendingReadAdapterTest {
    ...
    void mapsLegacySnapshotsWithoutGrowthAndIgnoresIncompleteDocuments() {
        ...
        assertThat(result).singleElement().satisfies(trend -> {
            ...
            assertThat(trend.growth()).isEqualTo(com.toonlira.application.trending.port.TrendingReadPort.Growth.EMPTY);
        });
    }
