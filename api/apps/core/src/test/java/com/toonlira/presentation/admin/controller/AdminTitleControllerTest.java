...
@org.springframework.context.annotation.Import(com.toonlira.presentation.admin.mapper.AdminTitleMapper.class)
...
class AdminTitleControllerTest {
    ...
    @MockitoBean
    private com.toonlira.application.manga.service.TitleStoreAssociationReader titleStoreAssociationReader;
    ...
    private Title buildTitle() {
        return Title.builder()
                .id("title-1")
                .name(com.toonlira.shared.domain.i18n.LocalizedString.ofDefault("Naruto"))
                .type("manga")
                .cover("cover.jpg")
                .synopsis(com.toonlira.shared.domain.i18n.LocalizedString.ofDefault("A ninja story"))
    ...
    void deveRetornar200AoAtualizar() throws Exception {
        ...
        updated.setName(com.toonlira.shared.domain.i18n.LocalizedString.ofDefault("Naruto Shippuden"));
