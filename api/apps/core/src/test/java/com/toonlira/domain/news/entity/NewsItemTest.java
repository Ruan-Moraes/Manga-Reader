package com.toonlira.domain.news.entity;
...
class NewsItemTest {
    ...
    class BuilderDefaultTests {
        ...
        void shouldInitializeDefaults() {
            NewsItem news = NewsItem.builder()
                    .title(com.toonlira.shared.domain.i18n.LocalizedString.ofDefault("Nova serialização anunciada"))
    ...
    class BuilderAllFieldsTests {
        ...
        void shouldSetAllFieldsViaBuilder() {
            ...
            NewsItem news = NewsItem.builder()
                    .id("news-abc")
                    .title(com.toonlira.shared.domain.i18n.LocalizedString.ofDefault("One Piece ganha adaptação live action S2"))
                    .subtitle(com.toonlira.shared.domain.i18n.LocalizedString.ofDefault("Netflix anuncia segunda temporada"))
                    .excerpt(com.toonlira.shared.domain.i18n.LocalizedString.ofDefault("A Netflix confirmou oficialmente..."))
                    .content(com.toonlira.shared.domain.i18n.LocalizedStringList.ofDefault(List.of("Parágrafo 1", "Parágrafo 2", "Parágrafo 3")))
    ...
    class MutationTests {
        ...
        void shouldIncrementViewsAndTrending() {
            NewsItem news = NewsItem.builder()
                    .title(com.toonlira.shared.domain.i18n.LocalizedString.ofDefault("Notícia teste"))
        ...
        void shouldMarkAsFeaturedAndExclusive() {
            NewsItem news = NewsItem.builder()
                    .title(com.toonlira.shared.domain.i18n.LocalizedString.ofDefault("Notícia especial"))
