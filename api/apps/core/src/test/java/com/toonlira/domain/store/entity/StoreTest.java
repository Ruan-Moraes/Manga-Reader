package com.toonlira.domain.store.entity;
...
class StoreTest {
    ...
    class BuilderAllFieldsTests {
        ...
        void shouldSetAllFieldsViaBuilder() {
            Store store = Store.builder()
                    .name(com.toonlira.shared.domain.i18n.LocalizedString.ofDefault("Amazon Brasil"))
                    .logo("https://example.com/amazon-logo.png")
                    .icon("https://example.com/amazon-icon.png")
                    .description(com.toonlira.shared.domain.i18n.LocalizedString.ofDefault("Maior loja online do Brasil"))
                    .website("https://amazon.com.br")
    ...
    class AvailabilityTests {
        ...
        void shouldSupportAvailabilityChange() {
            Store store = Store.builder()
                    .name(com.toonlira.shared.domain.i18n.LocalizedString.ofDefault("Loja"))
