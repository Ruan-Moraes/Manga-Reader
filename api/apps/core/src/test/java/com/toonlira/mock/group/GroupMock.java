package com.toonlira.mock.group;
...
public final class GroupMock {
    ...
    public static Group activeGroup() {
        Group group = Group.builder()
                .id(GROUP_1_ID)
                .name(com.toonlira.shared.domain.i18n.LocalizedString.ofDefault("Scan Revolution"))
                .username("scan-revolution")
                .logo("https://picsum.photos/100/100?random=g1")
                .banner("https://picsum.photos/800/200?random=g1")
                .description(com.toonlira.shared.domain.i18n.LocalizedString.ofDefault("Grupo focado em traduzir mangás de ação e aventura para português."))
    ...
    public static Group inactiveGroup() {
        return Group.builder()
                .id(GROUP_2_ID)
                .name(com.toonlira.shared.domain.i18n.LocalizedString.ofDefault("Old Scans"))
                .username("old-scans")
                .description(com.toonlira.shared.domain.i18n.LocalizedString.ofDefault("Grupo inativo desde 2023."))
                .totalTitles(2)
                .foundedYear(2018)
    ...
    public static Group hiatusGroup() {
        return Group.builder()
                .id(GROUP_3_ID)
                .name(com.toonlira.shared.domain.i18n.LocalizedString.ofDefault("Paused Translations"))
                .username("paused-translations")
                .description(com.toonlira.shared.domain.i18n.LocalizedString.ofDefault("Em hiato temporário por falta de membros."))
                .totalTitles(3)
                .foundedYear(2021)
    ...
    public static Group emptyGroup() {
        return Group.builder()
                .id(UUID.randomUUID())
                .name(com.toonlira.shared.domain.i18n.LocalizedString.ofDefault("Novo Grupo"))
                .username("novo-grupo")
                .status(GroupStatus.ACTIVE)
                .groupUsers(new ArrayList<>())
                .translatedWorks(new ArrayList<>())
