...
import com.toonlira.application.event.usecase.admin.CreateEventUseCase;
import com.toonlira.application.event.usecase.admin.DeleteEventUseCase;
import com.toonlira.application.event.usecase.admin.GetAdminEventUseCase;
import com.toonlira.application.event.usecase.admin.ListAdminEventsUseCase;
import com.toonlira.application.event.usecase.admin.UpdateEventUseCase;
...
class AdminEventControllerTest {
    ...
    private Event buildEvent() {
        return Event.builder()
                .id(EVENT_ID)
                .title(com.toonlira.shared.domain.i18n.LocalizedString.ofDefault("Anime Expo"))
                .subtitle(com.toonlira.shared.domain.i18n.LocalizedString.ofDefault("Subtitle"))
                .description(com.toonlira.shared.domain.i18n.LocalizedString.ofDefault("Description"))
                .image("image.jpg")
    ...
    void deveRetornar200AoAtualizar() throws Exception {
        ...
        updated.setTitle(com.toonlira.shared.domain.i18n.LocalizedString.ofDefault("Updated Expo"));
