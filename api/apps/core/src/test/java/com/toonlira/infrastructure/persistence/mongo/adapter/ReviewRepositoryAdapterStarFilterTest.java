...
import com.toonlira.infrastructure.persistence.mongo.repository.ReviewMongoRepository;

@DataMongoTest
@ActiveProfiles("test")
@Import(MongoTestContainerConfig.class)
@DisplayName("ReviewRepositoryAdapter — filtro por estrela (DT-47)")
@Tag("testcontainers")
class RatingRepositoryAdapterStarFilterTest {
    ...
    void setUp() {
        ...
        adapter = new ReviewRepositoryAdapter(mongoRepository, mongoTemplate);
