package com.toonlira.mock.news;
...
import com.toonlira.domain.news.valueobject.NewsStatus;
...
public final class NewsMock {
    ...
    public static NewsItem featuredRelease() {
        return NewsItem.builder().status(NewsStatus.PUBLISHED)
                .id(NEWS_1_ID)
                .title(com.toonlira.shared.domain.i18n.LocalizedString.ofDefault("Novo capitulo de Reino de Aco bate recorde de visualizacoes"))
                .subtitle(com.toonlira.shared.domain.i18n.LocalizedString.ofDefault("Capitulo 8 teve mais de 50 mil leituras em 24 horas"))
                .excerpt(com.toonlira.shared.domain.i18n.LocalizedString.ofDefault("O mais recente capitulo da saga surpreendeu fas com um plot twist inesperado."))
                .content(com.toonlira.shared.domain.i18n.LocalizedStringList.ofDefault(new ArrayList<>(List.of(
    ...
    public static NewsItem exclusiveInterview() {
        return NewsItem.builder().status(NewsStatus.PUBLISHED)
                .id(NEWS_2_ID)
                .title(com.toonlira.shared.domain.i18n.LocalizedString.ofDefault("Entrevista exclusiva com Park Min-jun, criador de Lamina do Amanha"))
                .subtitle(com.toonlira.shared.domain.i18n.LocalizedString.ofDefault("O artista fala sobre inspiracoes e planos futuros"))
                .excerpt(com.toonlira.shared.domain.i18n.LocalizedString.ofDefault("Em entrevista ao Toonlira, Park Min-jun revela detalhes sobre o proximo arco."))
                .content(com.toonlira.shared.domain.i18n.LocalizedStringList.ofDefault(new ArrayList<>(List.of(
    ...
    public static NewsItem industryAnalysis() {
        return NewsItem.builder().status(NewsStatus.PUBLISHED)
                .id(NEWS_3_ID)
                .title(com.toonlira.shared.domain.i18n.LocalizedString.ofDefault("Mercado de manga no Brasil cresce 30% em 2025"))
                .subtitle(com.toonlira.shared.domain.i18n.LocalizedString.ofDefault("Dados da ABDR mostram expansao historica"))
                .excerpt(com.toonlira.shared.domain.i18n.LocalizedString.ofDefault("O setor de manga no Brasil vive seu melhor momento com crescimento recorde."))
                .content(com.toonlira.shared.domain.i18n.LocalizedStringList.ofDefault(new ArrayList<>(List.of(
    ...
    public static NewsItem eventCoverage() {
        return NewsItem.builder().status(NewsStatus.PUBLISHED)
                .id(NEWS_4_ID)
                .title(com.toonlira.shared.domain.i18n.LocalizedString.ofDefault("Cobertura completa do Manga Fest 2025"))
                .subtitle(com.toonlira.shared.domain.i18n.LocalizedString.ofDefault("Tudo o que aconteceu no maior evento de manga do ano"))
                .excerpt(com.toonlira.shared.domain.i18n.LocalizedString.ofDefault("Confira os destaques dos tres dias de evento."))
                .content(com.toonlira.shared.domain.i18n.LocalizedStringList.ofDefault(new ArrayList<>(List.of(
    ...
    public static NewsItem minimalNews() {
        return NewsItem.builder().status(NewsStatus.PUBLISHED)
                .id(NEWS_5_ID)
                .title(com.toonlira.shared.domain.i18n.LocalizedString.ofDefault("Nota rapida: Manutencao programada"))
                .excerpt(com.toonlira.shared.domain.i18n.LocalizedString.ofDefault("O site ficara fora do ar por 2 horas."))
                .content(com.toonlira.shared.domain.i18n.LocalizedStringList.ofDefault(new ArrayList<>(List.of("Manutencao programada para as 3h da manha."))))
