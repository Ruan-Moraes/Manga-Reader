package com.toonlira.domain.group.entity;
...
class GroupTest {
    ...
    class BuilderDefaultTests {
        ...
        void shouldInitializeDefaults() {
            Group group = Group.builder()
                    .name(com.toonlira.shared.domain.i18n.LocalizedString.ofDefault("Scanlation Team"))
                    .username("scan-team")
                    .build();
    ...
    class BuilderAllFieldsTests {
        ...
        void shouldSetAllFieldsViaBuilder() {
            Group group = Group.builder()
                    .name(com.toonlira.shared.domain.i18n.LocalizedString.ofDefault("Alpha Scans"))
                    .username("alpha-scans")
                    .logo("https://example.com/logo.png")
                    .banner("https://example.com/banner.png")
                    .description(com.toonlira.shared.domain.i18n.LocalizedString.ofDefault("Grupo de tradução focado em manhwa"))
    ...
    class GroupUserManagementTests {
        ...
        void shouldAddMemberToGroup() {
            Group group = Group.builder()
                    .name(com.toonlira.shared.domain.i18n.LocalizedString.ofDefault("Team"))
                    .username("team")
                    .build();
        ...
        void shouldAddMultipleMembersWithDifferentRoles() {
            Group group = Group.builder()
                    .name(com.toonlira.shared.domain.i18n.LocalizedString.ofDefault("Big Team"))
                    .username("big-team")
                    .build();
