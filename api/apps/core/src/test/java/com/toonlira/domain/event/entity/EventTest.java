package com.toonlira.domain.event.entity;
...
class EventTest {
    ...
    class BuilderDefaultTests {
        ...
        void shouldInitializeDefaults() {
            Event event = Event.builder()
                    .title(com.toonlira.shared.domain.i18n.LocalizedString.ofDefault("Anime Expo 2025"))
    ...
    class BuilderAllFieldsTests {
        ...
        void shouldSetAllFieldsViaBuilder() {
            ...
            Event event = Event.builder()
                    .title(com.toonlira.shared.domain.i18n.LocalizedString.ofDefault("MangaCon Brasil 2025"))
                    .subtitle(com.toonlira.shared.domain.i18n.LocalizedString.ofDefault("O maior evento de mangá do Brasil"))
                    .description(com.toonlira.shared.domain.i18n.LocalizedString.ofDefault("Descrição completa do evento"))
    ...
    class TicketTests {
        ...
        void shouldAddTicketsToEvent() {
            Event event = Event.builder()
                    .title(com.toonlira.shared.domain.i18n.LocalizedString.ofDefault("Evento teste"))
