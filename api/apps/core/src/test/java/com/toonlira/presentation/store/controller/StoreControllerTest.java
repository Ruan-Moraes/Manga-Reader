package com.toonlira.presentation.store.controller;
...
import com.toonlira.application.store.usecase.GetStoresByTitleIdUseCase;
import com.toonlira.application.store.usecase.GetStoresUseCase;
...
@org.springframework.context.annotation.Import({com.toonlira.presentation.store.mapper.StoreMapper.class, com.toonlira.presentation.shared.mapper.LocalizedMappingHelper.class, com.toonlira.shared.web.PageableWebConfig.class})
...
class StoreControllerTest {
    ...
    private Store buildStore(UUID id, String name) {
        return Store.builder()
                .id(id)
                .name(com.toonlira.shared.domain.i18n.LocalizedString.ofDefault(name))
