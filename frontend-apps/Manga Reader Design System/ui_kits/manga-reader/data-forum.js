// data-forum.js — comunidade fake: categorias, tópicos, comentários, usuários, eventos.
...
// Tags estilizadas — paleta fica em CSS via .forum-tag-<key>
window.FORUM_TAGS = {
...
// Usuários da comunidade — emoji-less, com badges/níveis
window.FORUM_USERS = {
  ak: { id:'ak', name:'AkariReads',    handle:'akarireads',    initials:'AK', color:'#ddda2a', level:42, badge:'Top Reader',  role:null         },
  ...
  rm: { id:'rm', name:'Ruan Moraes',   handle:'ruanmoraes',    initials:'RM', color:'#ddda2a', level:18, badge:null,           role:'admin'      },
...
window.FORUM_TOPICS = [
  {
    ...
    category:'staff', tags:['discussao'],
    authorId:'rm', when: 'há 2 dias',
    replies: 184, views: 8721, lastReplyAt: 'há 12 min', lastUserId:'tk',
    reactions: { up: 612, down: 4 },
  },
  {
    id:'t2', hot:true,
    ...
    category:'spoilers', tags:['spoiler','teoria','capitulo'],
    authorId:'ak', when:'há 4 horas',
    replies: 421, views: 12482, lastReplyAt:'há 3 min', lastUserId:'bs',
    reactions: { up: 482, down: 12 },
    hasSpoilerContent: true,
  },
  {
    id:'t3',
    ...
    category:'discussao', tags:['discussao'],
    authorId:'yl', when:'há 8 horas',
    replies: 87, views: 3214, lastReplyAt:'há 22 min', lastUserId:'ak',
    reactions: { up: 198, down: 2 },
  },
  {
    id:'t4',
    ...
    category:'recs', tags:['recomendacao','ajuda'],
    authorId:'jp', when:'há 1 dia',
    replies: 42, views: 1872, lastReplyAt:'há 1 hora', lastUserId:'hl',
    reactions: { up: 64, down: 0 },
  },
  {
    id:'t5',
    ...
    category:'spoilers', tags:['vazamento','spoiler'],
    authorId:'tk', when:'há 3 horas',
    replies: 312, views: 9408, lastReplyAt:'há 8 min', lastUserId:'ak',
    reactions: { up: 244, down: 31 },
    hasSpoilerContent: true,
  },
  {
    id:'t6',
    ...
    category:'manhwa', tags:['anime','discussao'],
    authorId:'kj', when:'há 2 dias',
    replies: 156, views: 4821, lastReplyAt:'há 2 horas', lastUserId:'mz',
    reactions: { up: 89, down: 14 },
  },
  {
    id:'t7',
    ...
    category:'discussao', tags:['ajuda','discussao'],
    authorId:'hl', when:'há 3 dias',
    replies: 28, views: 942, lastReplyAt:'há 5 horas', lastUserId:'jp',
    reactions: { up: 47, down: 1 },
  },
  {
    id:'t8',
    ...
    category:'manga', tags:['discussao'],
    authorId:'bs', when:'há 5 dias',
    replies: 198, views: 6231, lastReplyAt:'há 4 horas', lastUserId:'ak',
    reactions: { up: 312, down: 8 },
  },
];

// Comentários do tópico aberto (t2 — One Piece)
window.FORUM_COMMENTS = [
  {
    id:'c1', userId:'ak',
    when:'há 4 horas', edited:false,
  ...
  },
  {
    ...
    reactions: { up: 156, down: 2 },
    role:'mod',
    replies: [
      {
        id:'c2-r1', userId:'ak',
        when:'há 2 horas',
        text:'Exatamente esse o ponto. O silêncio narrativo do Oda nunca é gratuito.',
        reactions: { up: 42, down: 0 },
      },
      {
        id:'c2-r2', userId:'jp',
        when:'há 1 hora',
        text:'Mano, vocês dois deviam abrir um podcast. Eu pago.',
        reactions: { up: 28, down: 0 },
      },
    ],
  },
  {
    id:'c3', userId:'kj',
    when:'há 2 horas', edited:true,
    ...
    reactions: { up: 98, down: 6 },
  },
  {
    id:'c4', userId:'hl',
    when:'há 1 hora', edited:false,
    ...
    reactions: { up: 14, down: 1 },
  },
  {
    id:'c5', userId:'tk',
    when:'há 22 min', edited:false,
    ...
    reactions: { up: 211, down: 3 },
    role:'mod',
  },
];

// Trending tópicos (sidebar direita)
window.FORUM_TRENDING = [
...
// Comentários recentes — feed na sidebar direita
window.FORUM_RECENT_COMMENTS = [
...
// Ranking — usuários mais ativos da semana
window.FORUM_RANKING = [
