...
export type TabKey = 'reading' | 'appearance' | 'language' | 'notifications' | 'privacy';
...
export const sectionTitleClass = 'text-[0.7rem] font-semibold tracking-[0.14em] uppercase text-quaternary-default';
