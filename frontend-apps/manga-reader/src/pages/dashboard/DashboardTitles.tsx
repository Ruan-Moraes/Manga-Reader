...
import { AdminTitleList, ConfirmDeleteWithIdModal, useAdminTitles, useAdminTitleActions, type AdminTitle } from '@features/admin';
    ...
    return (
        <div className="flex flex-col gap-4">
            <div className="flex items-center justify-between">
                <h1 className="text-lg font-bold">{t('dashboard.titles.title')}</h1>
                <div className="flex items-center gap-3">
                    <span className="text-sm text-tertiary">{t('dashboard.titles.count', { count: totalElements })}</span>
                    <button
                        onClick={() => navigate(`${WEB_BASE_URL}${ROUTES.DASHBOARD_TITLE_FORM}`)}
