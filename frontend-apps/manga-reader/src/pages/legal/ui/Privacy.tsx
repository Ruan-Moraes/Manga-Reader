...
export default function Privacy() {
    ...
    const compartilhamentoItems = t(
        'privacy.sections.compartilhamento.items',
        { returnObjects: true },
    ) as string[];
    ...
    return (
        ...
        >
            <LegalSection
                id="tldr"
                num={1}
                title={t('privacy.sections.tldr.title')}
                tldr={t('privacy.sections.tldr.tldr')}
            >
            ...
            <LegalSection
                id="coleta"
                num={2}
                title={t('privacy.sections.coleta.title')}
            >
            ...
            <LegalSection
                id="uso"
                num={3}
                title={t('privacy.sections.uso.title')}
            >
            ...
            <LegalSection
                id="base-legal"
                num={4}
                title={t('privacy.sections.base-legal.title')}
            >
                ...
                <ul className="mt-2 list-disc space-y-1 pl-5 text-mr-fg-muted">
                    {baseLegalItems.map((_, idx) => (
                        <li key={idx}>
                            <Trans
                                i18nKey={`privacy.sections.base-legal.items.${idx}`}
                                ns="legal"
            ...
            <LegalSection
                id="compartilhamento"
                num={5}
                title={t('privacy.sections.compartilhamento.title')}
            >
                ...
                <ul className="mt-2 list-disc space-y-1 pl-5 text-mr-fg-muted">
                    {compartilhamentoItems.map((_, idx) => (
                        <li key={idx}>
                            <Trans
                                i18nKey={`privacy.sections.compartilhamento.items.${idx}`}
                                ns="legal"
                                components={{ strong: <strong /> }}
                            />
                        </li>
                ...
                <p className="mt-3">
                    {t('privacy.sections.compartilhamento.outro')}
                </p>
            </LegalSection>
            ...
            <LegalSection
                id="direitos"
                num={7}
                title={t('privacy.sections.direitos.title')}
            >
                ...
                <p className="mt-3">
                    <Trans
                        ...
                        components={{
                            mail: (
                                <a
                                    href="mailto:dpo@manga-reader.example.com"
            ...
            <LegalSection
                id="retencao"
                num={8}
                title={t('privacy.sections.retencao.title')}
            >
            ...
            <LegalSection
                id="seguranca"
                num={9}
                title={t('privacy.sections.seguranca.title')}
            >
            ...
            <LegalSection
                id="criancas"
                num={10}
                title={t('privacy.sections.criancas.title')}
            >
            ...
            <LegalSection
                id="internacional"
                num={11}
                title={t('privacy.sections.internacional.title')}
            >
            ...
            <LegalSection
                id="dpo"
                num={12}
                title={t('privacy.sections.dpo.title')}
            >
            ...
            >
                <div>
                    <p className="text-mr-body font-mr-extrabold text-mr-fg">
                        {t('privacy.footerCard.title')}
                    </p>
                    <p className="text-mr-small text-mr-fg-muted">
                        {t('privacy.footerCard.desc')}
                    </p>
                </div>
                <Button
                    variant="primary"
