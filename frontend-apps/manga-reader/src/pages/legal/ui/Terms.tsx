    ...
    return (
        ...
        >
            <LegalSection
                id="aceite"
                num={1}
                title={t('terms.sections.aceite.title')}
                tldr={t('terms.sections.aceite.tldr')}
            >
            ...
            <LegalSection
                id="conta"
                num={2}
                title={t('terms.sections.conta.title')}
                tldr={t('terms.sections.conta.tldr')}
            >
                <p>{t('terms.sections.conta.p1')}</p>
                <p>{t('terms.sections.conta.p2')}</p>
                <p>
                    <Trans
                        i18nKey="terms.sections.conta.p3"
                        ns="legal"
            ...
            <LegalSection
                id="uso"
                num={3}
                title={t('terms.sections.uso.title')}
                tldr={t('terms.sections.uso.tldr')}
            >
            ...
            <LegalSection
                id="comunidade"
                num={4}
                title={t('terms.sections.comunidade.title')}
                tldr={t('terms.sections.comunidade.tldr')}
            >
            ...
            <LegalSection
                ...
                num={5}
                title={t('terms.sections.direitos-autorais.title')}
                tldr={t('terms.sections.direitos-autorais.tldr')}
            >
                <p>{t('terms.sections.direitos-autorais.p1')}</p>
                <p>
                    <Trans
                        i18nKey="terms.sections.direitos-autorais.p2"
                        ns="legal"
                        components={{ strong: <strong /> }}
                    />
                </p>
            ...
            <LegalSection
                id="pagamentos"
                num={6}
                title={t('terms.sections.pagamentos.title')}
                tldr={t('terms.sections.pagamentos.tldr')}
            >
            ...
            <LegalSection
                id="encerramento"
                num={7}
                title={t('terms.sections.encerramento.title')}
                tldr={t('terms.sections.encerramento.tldr')}
            >
            ...
            <LegalSection
                id="isencoes"
                num={8}
                title={t('terms.sections.isencoes.title')}
                tldr={t('terms.sections.isencoes.tldr')}
            >
            ...
            <LegalSection
                id="mudancas"
                num={9}
                title={t('terms.sections.mudancas.title')}
                tldr={t('terms.sections.mudancas.tldr')}
            >
            ...
            <LegalSection
                id="lei"
                num={10}
                title={t('terms.sections.lei.title')}
                tldr={t('terms.sections.lei.tldr')}
            >
            ...
            >
                <div>
                    <p className="text-mr-body font-mr-extrabold text-mr-fg">
                        {t('terms.footerCard.title')}
                    </p>
                    <p className="text-mr-small text-mr-fg-muted">
                        {t('terms.footerCard.desc')}
                    </p>
                </div>
                <Button
                    variant="primary"
