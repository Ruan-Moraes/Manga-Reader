...
export default function HelpArticle() {
    ...
    return (
        <div>
            ...
            {/* Body */}
            <PageContainer asMain size="narrow" paddingY="lg">
                ...
                <section className="mt-10 rounded-mr-md border border-mr-border bg-mr-surface p-5">
                    <p className="mb-3 text-mr-body font-mr-bold text-mr-fg">
                        {t('article.helpfulTitle')}
                    </p>
                    ...
                    <section className="mt-10">
                        ...
                        <div className="flex flex-col divide-y divide-mr-border-subtle overflow-hidden rounded-mr-md border border-mr-border">
                            {related.map(a => (
                                ...
                                >
                                    <span className="min-w-0 flex-1 truncate text-mr-body font-mr-bold text-mr-fg">
                                        {t(`items.${a.id}`)}
                                    </span>
