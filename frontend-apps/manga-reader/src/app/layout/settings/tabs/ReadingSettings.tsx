...
const ReadingSettings = ({ settings, onUpdate }: SettingsTabProps) => {
    ...
    const modeOptions = useMemo(
        () => [
            {
                value: 'continuous',
                label: t('settings.reading.mode.continuous'),
            },
    ...
    return (
        <div className="space-y-4">
            ...
            <div className="flex flex-col gap-1.5">
                <span className="text-xs font-bold">{t('settings.reading.modeLabel')}</span>
                <Select
                    options={modeOptions}
            ...
            <div className="flex flex-col gap-1.5">
                <span className="text-xs font-bold">{t('settings.reading.directionLabel')}</span>
                <Select
            ...
            <div className="flex flex-col gap-1.5">
                <span className="text-xs font-bold">{t('settings.reading.imageQualityLabel')}</span>
                <Select
