...
function ForgotScreen({ radius = 2, reviewState = 'interativo', onNavigate = () => {} }) {
        ...
        return (
            <div style={window.authScreenStyle({ justifyContent: 'center', alignItems: 'center', textAlign: 'center' })}>
                ...
                <p style={{ margin: '14px 0 28px', fontSize: 13, lineHeight: 1.6, color: MR.subtle, letterSpacing: MR.ls, maxWidth: 300 }}>
                    Mandamos um link de recuperação para <strong style={{ color: MR.text, wordBreak: 'break-all' }}>{sentEmail}</strong>. Ele vale por 30
                    minutos.
                </p>
