        ...
        return (
            <div style={window.authScreenStyle({ justifyContent: 'center', alignItems: 'center', textAlign: 'center' })}>
                <div style={{ position: 'relative', marginBottom: 22 }}>
                    ...
                    />
                    <img src="assets/feliz.png" alt="" width={148} height={148} style={{ position: 'relative', display: 'block', width: 148, height: 148 }} />
                </div>
                <div
                    style={{
                        display: 'inline-flex',
            ...
            <form onSubmit={submit} noValidate style={{ display: 'flex', flexDirection: 'column' }}>
                ...
                {showBiometric && (
                    <div style={{ marginTop: 12 }}>
                        <window.GhostButton icon="face-id" radius={radius}>
                            Entrar com Face ID
                        </window.GhostButton>
                    </div>
                )}
                ...
                {showDemo && (
                    <div
                        style={{
                            marginTop: 22,
                            padding: 14,
                            borderRadius: Math.min(radius + 2, 6),
