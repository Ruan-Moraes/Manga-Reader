...
Nenhuma divergência normativa ou ampliação funcional. O acabamento altera
somente apresentação, responsividade e semântica dos contratos existentes.
...
Spec, tasks, registry, coverage, primitivas compartilhadas, features, widget do
índice, sete subtelas, i18n, testes e matriz nativa.
