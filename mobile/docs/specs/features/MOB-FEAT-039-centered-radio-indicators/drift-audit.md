...
Nenhuma divergência normativa ou ampliação funcional. Geometria, opções,
callbacks, persistência, i18n e semântica permanecem inalterados.
...
Spec, tasks, registry, coverage, quatro componentes compartilhados de rádio,
testes dos consumidores e gates completos.
