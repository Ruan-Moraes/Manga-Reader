...
Nenhuma divergência normativa ou ampliação funcional. Valores, opções, stores,
persistência e consumidores permanecem inalterados.
...
consumidores, auditoria nativa iOS e contrato Android.
