...
| AC-004   | TASK-004, TASK-013 | SQLite v3→v4, constraints, FK, reload e rollback                           |
| AC-005   | TASK-005           | Integração de lote misto, remoção e substituição                           |
| AC-006   | TASK-006, TASK-013 | Repository para append/remove/reorder/language preservando identidade      |
| AC-007   | TASK-007           | Fixture arte-only válida sem detector de texto                             |
| AC-008   | TASK-008, TASK-014 | Leitura limitada/sequencial e profiling físico Android                     |
...
| AC-011   | TASK-011, TASK-013 | Duplo toque, interrupção, stale draft, falha transacional e retry seletivo |
