...
import { MR } from '@/src/constants/theme';

type IconName =
  | 'mail' | 'lock' | 'eye' | 'eye-off' | 'face-id'
  | 'check' | 'user' | 'arrow-left' | 'arrow-right'
  | 'send' | 'alert' | 'google' | 'apple';
    ...
    case 'google':
      return (
        <Svg width={size} height={size} viewBox="0 0 24 24">
          ...
          <Path d="M12 22c2.7 0 5-.9 6.6-2.5l-3.2-2.5c-.9.6-2 1-3.4 1-2.6 0-4.8-1.7-5.6-4.1H3.1v2.6A10 10 0 0 0 12 22Z" fill="#34A853" stroke="none" />
