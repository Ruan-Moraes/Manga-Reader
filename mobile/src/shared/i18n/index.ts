...
export const NAMESPACES = ['common', 'auth', 'launcher', 'reader', 'settingsNavigation'] as const;

const resources = {
    'pt-BR': { common: ptBRCommon, auth: ptBRAuth, launcher: ptBRLauncher, reader: ptBRReader, settingsNavigation: ptBRSettingsNavigation },
    'en-US': { common: enUSCommon, auth: enUSAuth, launcher: enUSLauncher, reader: enUSReader, settingsNavigation: enUSSettingsNavigation },
    'es-ES': { common: esESCommon, auth: esESAuth, launcher: esESLauncher, reader: esESReader, settingsNavigation: esESSettingsNavigation },
};
