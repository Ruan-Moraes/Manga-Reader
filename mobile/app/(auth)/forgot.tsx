        ...
        return (
            <View
                style={{
                    ...
                    alignItems: 'center',
                    paddingHorizontal: MR.screenPadding,
                    paddingVertical: 24,
                }}
            >
                ...
                <View
                    style={{
                        ...
                        paddingVertical: 5,
                        borderRadius: 999,
                        backgroundColor: `${MR.accent}28`,
                        borderWidth: 1,
                        borderColor: `${MR.accent}80`,
                    }}
                >
                ...
                >
                    Mandamos um link de recuperação para <Text style={{ color: MR.text, fontFamily: FONTS.bold }}>{email.trim()}</Text>. Ele vale por 30
                    minutos.
                </Text>
                ...
                <TouchableOpacity onPress={retry} style={{ marginTop: 18 }}>
                    <Text style={{ fontFamily: FONTS.regular, fontSize: 13, color: MR.subtle, letterSpacing: MR.ls }}>
                        Errou o e-mail? <Text style={{ color: MR.accent, fontFamily: FONTS.bold }}>Tentar de novo</Text>
                    </Text>
                </TouchableOpacity>
            </View>
        );
        ...
        <KeyboardAvoidingView style={{ flex: 1, backgroundColor: MR.bg }} behavior={Platform.OS === 'ios' ? 'padding' : 'height'}>
            ...
            >
                ...
                >
                    ...
                    <Text style={{ fontFamily: FONTS.regular, fontSize: 13, color: MR.subtle, letterSpacing: MR.ls }}>Voltar pro login</Text>
                </TouchableOpacity>
                ...
                <AuthFooter prompt="Lembrou a senha?" action="Voltar pro login" onAction={() => router.back()} />
            </ScrollView>
