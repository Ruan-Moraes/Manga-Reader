...
export default function RegisterScreen() {
    ...
    return (
        <KeyboardAvoidingView style={{ flex: 1, backgroundColor: MR.bg }} behavior={Platform.OS === 'ios' ? 'padding' : 'height'}>
            ...
            >
                <AuthHeader eyebrow="Junte-se à comunidade" title="Criar conta" sub="É grátis e sem anúncios. Leve sua estante pra qualquer lugar." />
                ...
                >
                    <Text style={{ fontFamily: FONTS.regular, fontSize: 13, color: errors.terms ? MR.danger : MR.muted, letterSpacing: MR.ls, lineHeight: 19 }}>
                        Li e aceito os <Text style={{ color: MR.accent, fontFamily: FONTS.bold }}>Termos</Text> e a{' '}
                ...
                <AuthFooter prompt="Já tem conta?" action="Entrar" onAction={() => router.back()} />
            </ScrollView>
