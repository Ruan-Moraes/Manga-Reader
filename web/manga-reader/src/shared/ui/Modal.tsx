...
export const Modal = ({ open, onClose, title, description, eyebrow, size = 'md', hideClose, children, footer, danger, bodyClassName }: ModalProps) => {
    ...
    return (
        <dialog
            ...
            className={`m-auto p-0 ${sizeMap[size]} w-[90vw] rounded-mr-md border border-mr-border bg-mr-surface text-mr-fg shadow-mr-black animate-mr-fade-in [&::backdrop]:bg-[rgba(22,22,22,0.75)] [&::backdrop]:backdrop-blur-mr`}
        ...
        >
            <header className="flex items-center justify-between gap-4 border-b border-mr-border-subtle p-2 sm:p-4">
                <div className="min-w-0 flex-1">
                    ...
                    <h2 id="modal-title" className={`text-mr-body! sm:text-mr-h3! font-mr-extrabold! ${danger ? 'text-mr-danger' : 'text-mr-fg'}`}>
                        {title}
                    </h2>
