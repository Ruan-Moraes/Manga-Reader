 ...
 *
 * O api retorna códigos técnicos padronizados (campo `code` no body de erro).
...
// ---------------------------------------------------------------------------
// Fallback por HTTP status (quando o api não retorna código)
// ---------------------------------------------------------------------------
 ...
 * 2. `serverMessage` (mensagem do api, se presente)
