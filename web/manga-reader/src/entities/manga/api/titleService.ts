...
export const searchTitles = async (query: string, page = 0, size = 20): Promise<PageResponse<Title>> => {
    const response = await api.get<ApiResponse<PageResponse<Title>>>(API_URLS.TITLES_SEARCH, { params: { q: query, page, size } });
