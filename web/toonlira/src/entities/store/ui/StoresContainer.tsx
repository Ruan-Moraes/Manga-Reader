...
function StoresEmpty() {
    ...
    return (
        <div className="flex flex-col items-center gap-4 py-12 text-center">
            ...
            <div>
                <h2 className="text-[20px] font-ui-extrabold text-ui-fg">{t('empty.title')}</h2>
                <p className="mt-1 max-w-[360px] text-[14px] text-ui-fg-muted">{t('empty.desc')}</p>
            </div>
            {notified ? (
                <span className="flex items-center gap-2 text-[14px] font-ui-bold text-ui-accent-fg">
    ...
    return (
        <div>
            <div className="mb-4 flex items-baseline gap-2">
                <h2 className="text-[18px] font-ui-extrabold text-ui-fg">{t('container.title')}</h2>
                <span className="text-[13px] text-ui-fg-subtle">{t('container.count', { count: stores.length })}</span>
            </div>
            <div className="flex flex-col gap-3">
                {stores.map(s => (
