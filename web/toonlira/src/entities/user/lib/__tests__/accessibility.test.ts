...
describe('system preferences storage', () => {
    ...
    it('applies global preference classes to html', () => {
        ...
        expect(document.documentElement.classList.contains('ui-no-animations')).toBe(true);
        expect(document.documentElement.classList.contains('ui-font-comfortable')).toBe(true);
        expect(document.documentElement.classList.contains('ui-density-compact')).toBe(true);
        expect(document.documentElement.classList.contains('ui-high-contrast')).toBe(true);
        expect(document.documentElement.classList.contains('ui-theme-system')).toBe(true);
    ...
    it('applies LIGHT without a dark theme class', () => {
        ...
        expect(document.documentElement.classList.contains('ui-theme-light')).toBe(true);
        expect(document.documentElement.classList.contains('ui-theme-dark')).toBe(false);
    });

    it.each([
        ['LIGHT', false, 'ui-theme-light'],
        ['LIGHT', true, 'ui-theme-light'],
        ['DARK', false, 'ui-theme-dark'],
        ['DARK', true, 'ui-theme-dark'],
        ...
        expect(document.documentElement.classList.contains('ui-high-contrast')).toBe(highContrast);
    });
});
