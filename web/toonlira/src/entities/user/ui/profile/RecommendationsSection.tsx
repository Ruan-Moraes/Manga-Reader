...
import { type RecommendedTitle } from '../../model/user.types';
import { addRecommendation, removeRecommendation } from '../../api/userService';
                    ...
                    <div key={rec.titleId} className="relative group">
                        ...
                        {isOwner && (
                            <button
                                ...
                                className="absolute top-1 right-1 px-1.5 py-0.5 text-xs bg-quinary-default/80 text-ui-on-overlay rounded-xs opacity-0 group-hover:opacity-100 transition-opacity"
                            >
                                X
                            </button>
                        )}
