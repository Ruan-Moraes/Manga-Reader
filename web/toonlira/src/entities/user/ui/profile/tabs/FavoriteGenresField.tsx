                ...
                {(tags ?? []).map((tag: Tag) => {
                    ...
                    return (
                        <button
                            ...
                            className={cn(
                                'ui-focus-ring rounded-ui-xs border px-2.5 py-1 text-[12px] font-ui-bold tracking-mr transition-colors',
                                selected
                                    ? 'border-ui-accent-border bg-ui-accent text-ui-on-accent'
                                    : 'border-ui-gray-700 bg-ui-secondary text-ui-fg-muted hover:border-ui-accent-50',
                                atLimit && 'cursor-not-allowed opacity-ui-disabled',
                            )}
                        >
                            {tag.label}
                        </button>
