...
const BANNER_FALLBACK = 'var(--ui-banner-gradient)';
...
const statusClassMap = {
    active: 'text-ui-success border-ui-success/40',
    hiatus: 'text-ui-warning border-ui-warning/40',
    inactive: 'text-ui-danger border-ui-danger/40',
};
            ...
            <div className="relative p-4 -mt-12">
                <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
                    <div className="flex gap-4 items-end">
                        <div className="overflow-hidden border-2 rounded-ui-xs border-ui-accent-border" aria-label={t('header.avatarAlt', { name: group.name })}>
                    ...
                    <a
                        ...
                        target="_blank"
                        rel="noreferrer"
                        className="flex gap-2 items-center text-sm text-tertiary transition-colors hover:text-ui-accent-fg"
                    >
                ...
                <div className="grid grid-cols-2 gap-2 mt-4 text-sm mobile-lg:grid-cols-5">
                    <button
                        ...
                        className="flex gap-2 justify-center items-center p-2 border rounded-xs border-tertiary hover:border-ui-accent-border transition-colors"
                    >
                        <Users />
                        {t('card.membersCount', {
