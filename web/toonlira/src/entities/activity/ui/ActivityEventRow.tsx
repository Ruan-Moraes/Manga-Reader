...
const ActivityEventRow = ({ event, actions }: ActivityEventRowProps) => {
    ...
    return (
        <div className="flex items-center gap-3 rounded-ui-xs border border-ui-border bg-ui-surface px-4 py-3">
            {href ? (
            ...
            <span className="shrink-0 text-ui-tiny text-ui-fg-subtle" title={whenTitle}>
                {when}
            </span>
