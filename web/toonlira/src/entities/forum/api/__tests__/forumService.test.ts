...
import type { ForumTopic } from '../../model/forum.types';
...
describe('forumService', () => {
    ...
    describe('getCategoryColor', () => {
        it('deve retornar tokens semânticos para cada categoria', () => {
            expect(getCategoryColor('Geral')).toContain('ui-info');
            expect(getCategoryColor('Spoilers')).toContain('ui-danger');
            expect(getCategoryColor('Fanart')).toContain('ui-danger');
        });
    });
