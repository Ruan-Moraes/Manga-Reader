...
export const getCategoryColor = (category: ForumCategory): string => {
    const colors: Record<ForumCategory, string> = {
        Geral: 'bg-ui-info/15 text-ui-info',
        Recomendações: 'bg-ui-success/15 text-ui-success',
        Spoilers: 'bg-ui-danger/15 text-ui-danger',
        Suporte: 'bg-ui-warning/15 text-ui-warning',
        'Off-topic': 'bg-ui-surface-muted text-ui-fg-muted',
        Teorias: 'bg-ui-accent/15 text-ui-accent-fg',
        Fanart: 'bg-ui-danger/15 text-ui-danger',
...
export const roleBadgeColor: Record<string, string> = {
    admin: 'bg-ui-danger/15 text-ui-danger',
    moderator: 'bg-ui-info/15 text-ui-info',
    member: 'bg-ui-surface-muted text-ui-fg-muted',
};
