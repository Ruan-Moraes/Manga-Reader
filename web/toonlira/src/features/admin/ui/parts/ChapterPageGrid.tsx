    ...
    return (
        <div className="flex flex-col gap-4">
            <div className="flex flex-wrap items-center gap-2.5">
                ...
                <span className="ml-auto text-ui-tiny text-ui-fg-subtle">{t('dashboard.chapters.pages.count', { count: pages.length })}</span>
            </div>

            {readOnly && (
                <p role="status" className="rounded-ui-sm border border-ui-border bg-ui-surface-muted px-3 py-2 text-ui-small text-ui-fg-subtle">
