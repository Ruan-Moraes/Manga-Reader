        ...
        >
            <div className="flex flex-col gap-4">
                <label className="flex flex-col gap-1.5">
                    <span className="text-ui-small font-ui-bold text-ui-fg-muted">{t('grantSubscription.userIdLabel')}</span>
                    <Input type="text" value={userId} onChange={e => setUserId(e.target.value)} placeholder={t('grantSubscription.userIdPlaceholder')} />
                </label>
                <label className="flex flex-col gap-1.5">
                    <span className="text-ui-small font-ui-bold text-ui-fg-muted">{t('grantSubscription.planIdLabel')}</span>
