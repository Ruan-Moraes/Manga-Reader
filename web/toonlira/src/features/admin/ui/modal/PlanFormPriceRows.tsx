    ...
    return (
        <div className="flex flex-col gap-2">
            <span className="text-xs font-bold">
                ...
                <span className="ml-1 text-ui-danger">*</span>
            </span>
                ...
                <div key={idx} className="flex gap-2 items-start">
                    ...
                    {rows.length > 1 && (
                        <button
                            ...
                            className="mt-1.5 p-1.5 text-ui-danger border border-ui-danger-border rounded-xs hover:bg-ui-danger-15"
                        >
                            <Trash2 size={14} />
                        </button>
                    )}
            ...
            {availableCurrencyOptions.length > 0 && (
                <button type="button" onClick={addPriceRow} className="flex items-center gap-1.5 text-xs text-tertiary hover:text-ui-fg w-fit">
                    <Plus size={12} />
