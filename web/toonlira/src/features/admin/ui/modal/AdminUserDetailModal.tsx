...
const InfoRow = ({ label, children }: { label: string; children: React.ReactNode }) => (
    <div className="flex items-center justify-between gap-3 border-b border-ui-gray-900 py-2.5 last:border-b-0">
        ...
        <span className="min-w-0 text-right text-ui-small font-ui-bold text-ui-fg">{children}</span>
    </div>
);
                ...
                <div className="flex flex-col gap-4">
                    <div className="flex items-center gap-4 border-b border-ui-gray-900 pb-4">
                        ...
                        <div className="min-w-0">
                            <div className="text-ui-h4 font-ui-extrabold text-ui-fg">{user.name}</div>
                            <div className="break-all text-ui-small text-ui-fg-subtle">{user.email}</div>
                    ...
                    <div>
                        <InfoRow label={t('userDetail.id')}>
                            <code className="font-ui-mono text-ui-tiny text-ui-fg-subtle">{user.id}</code>
                        </InfoRow>
                    ...
                    {user.banned && (
                        <div className="rounded-ui-sm border border-ui-danger-border bg-ui-danger-15 p-3">
                            <h4 className="mb-2 text-ui-small font-ui-bold text-ui-danger">{t('userDetail.banDetails')}</h4>
