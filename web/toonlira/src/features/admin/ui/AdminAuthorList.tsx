...
const buildColumns = (t: TFunction, onEdit: (a: AdminAuthor) => void, onDelete: (a: AdminAuthor) => void): Column<AdminAuthor>[] => [
    {
        ...
        sortable: true,
        render: author => <span className="font-ui-bold text-ui-fg">{author.name}</span>,
    },
    {
        key: 'slug',
        header: t('authorList.columnSlug'),
        hideBelow: 'sm',
        render: author => <span className="font-ui-mono text-ui-tiny text-ui-fg-subtle">{author.slug}</span>,
    },
    {
        key: 'nationality',
        header: t('authorList.columnNationality'),
        hideBelow: 'sm',
        render: author => <span className="text-ui-fg-subtle">{author.nationality ?? '—'}</span>,
    },
    {
        key: 'createdAt',
        ...
        sortable: true,
        hideBelow: 'md',
        render: author => <span className="text-ui-fg-subtle">{formatDate(author.createdAt)}</span>,
    },
    {
        key: 'actions',
