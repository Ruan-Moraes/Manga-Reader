...
const buildColumns = (t: TFunction, onEdit: (user: AdminUser) => void, onDelete: (user: AdminUser) => void): Column<AdminUser>[] => [
    {
        ...
        hideBelow: 'md',
        render: user => <span className="font-ui-mono text-ui-tiny text-ui-fg-subtle">{user.id.slice(0, 8)}</span>,
    },
    {
        key: 'name',
        ...
        render: user => (
            <span className="flex items-center gap-2.5">
                ...
                <span className="font-ui-bold text-ui-fg">{user.name}</span>
            </span>
        ),
    },
    {
        ...
        sortable: true,
        hideBelow: 'sm',
        render: user => <span className="text-ui-fg-subtle">{user.email}</span>,
    },
    {
        key: 'role',
    ...
    },
    {
        ...
        sortable: true,
        hideBelow: 'md',
        render: user => <span className="text-ui-fg-subtle">{formatDate(user.createdAt)}</span>,
    },
    {
        key: 'actions',
