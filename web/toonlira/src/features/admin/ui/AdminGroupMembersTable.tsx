...
const RoleBadge = ({ role }: { role: string | null }) => {
    if (!role) return <span className="text-ui-fg-subtle">—</span>;
                                    ...
                                    <td className="px-4 py-3 text-right">
                                        <div className="flex items-center justify-end gap-2">
                                            ...
                                            <button
                                                ...
                                                className="px-2 py-1 text-xs text-ui-danger border rounded-ui-xs border-ui-danger-border hover:bg-ui-danger-15 transition-colors disabled:opacity-50"
                                            >
