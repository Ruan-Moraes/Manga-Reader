...
const buildColumns = (
...
): Column<AdminTitle>[] => [
    {
        ...
        hideBelow: 'md',
        render: title => <span className="font-ui-mono text-ui-tiny text-ui-fg-subtle">{title.id.slice(0, 8)}</span>,
    },
    {
        key: 'name',
        header: t('dashboard.titles.columnName'),
        sortable: true,
        render: title => <span className="font-ui-bold text-ui-fg">{title.name?.[lang] ?? title.name?.['pt-BR'] ?? ''}</span>,
    },
    {
        key: 'type',
    ...
    },
    {
        ...
        render: title => {
            ...
            return <span className="text-ui-fg-subtle">{names || '—'}</span>;
        },
    },
    {
        key: 'chaptersCount',
        ...
        sortable: true,
        hideBelow: 'md',
        render: title => <span className="tabular-nums text-ui-fg-subtle">{title.chaptersCount}</span>,
    },
    {
        key: 'createdAt',
        ...
        sortable: true,
        hideBelow: 'md',
        render: title => <span className="text-ui-fg-subtle">{formatDate(title.createdAt)}</span>,
    },
    {
        key: 'actions',
