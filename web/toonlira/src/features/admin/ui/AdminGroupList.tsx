...
const buildColumns = (t: TFunction, lang: LanguageTag, onEdit: (group: AdminGroup) => void, onDelete: (group: AdminGroup) => void): Column<AdminGroup>[] => [
    {
        ...
        hideBelow: 'md',
        render: group => <span className="font-ui-mono text-ui-tiny text-ui-fg-subtle">{group.id.slice(0, 8)}</span>,
    },
    {
        key: 'name',
        ...
        render: group => {
            ...
            return (
                <span className="flex items-center gap-2.5">
                    ...
                    <span className="font-ui-bold text-ui-fg">{name}</span>
                </span>
            );
        },
    },
    {
        ...
        sortable: true,
        hideBelow: 'sm',
        render: group => <span className="font-ui-mono text-ui-tiny text-ui-accent-fg">@{group.username}</span>,
    },
    {
        key: 'status',
    ...
    },
    {
        ...
        sortable: true,
        hideBelow: 'md',
        render: group => <span className="tabular-nums text-ui-fg-subtle">{group.membersCount}</span>,
    },
    {
        key: 'totalTitles',
        ...
        sortable: true,
        hideBelow: 'md',
        render: group => <span className="tabular-nums text-ui-fg-subtle">{group.totalTitles}</span>,
    },
    {
        ...
        sortable: true,
        hideBelow: 'md',
        render: group => <span className="text-ui-fg-subtle">{formatDate(group.platformJoinedAt)}</span>,
    },
    {
        key: 'actions',
