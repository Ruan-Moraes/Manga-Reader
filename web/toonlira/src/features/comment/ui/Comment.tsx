                ...
                replyingTo={
                    isReply && parentUserName ? (
                        <button
                            ...
                            className="inline-flex items-center gap-1 rounded-ui-full border border-ui-chip-border bg-ui-chip px-2 py-0.5 text-ui-tiny font-ui-semibold text-ui-fg-subtle transition-colors hover:border-ui-accent-50 hover:text-ui-accent-fg"
                        >
                            {t('reply.replyingTo')} <span className="font-ui-bold text-ui-accent-fg">{parentUserName}</span>
                        </button>
                    ) : null
                }
                name={user.name}
