            ...
            <div className="flex flex-col gap-2">
                <div className="flex items-center justify-between">
                    <div className="flex items-baseline gap-2">
                        <h3 className="text-[22px] font-ui-bold text-ui-fg">{t('section.title')}</h3>
                        <span className="text-ui-small text-ui-fg-subtle">{t('section.count', { count: totalElements ?? comments.length })}</span>
                    </div>
                    {onToggleCrossLanguage && (
                ...
                <div className="flex min-w-0 flex-col gap-4">
                    {getStoredSession() ? (
                        ...
                        <div className="flex min-w-0 flex-col items-stretch gap-4 rounded-ui-md border border-ui-chip-border bg-ui-chip p-4 md:flex-row md:items-center md:justify-between md:gap-3">
                            <div className="flex min-w-0 items-center gap-3">
                                <span className="flex size-9 shrink-0 items-center justify-center rounded-ui-full bg-ui-accent-25 text-ui-accent-fg">
                                    <LogIn className="size-4" aria-hidden="true" />
                                </span>
                                <p className="min-w-0 text-ui-small leading-relaxed text-ui-fg-subtle">{t('section.loginPrompt')}</p>
                            </div>
