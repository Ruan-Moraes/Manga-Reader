    ...
    return (
        <div className="flex gap-2">
            ...
            <button
                type="button"
                onClick={onConfirm}
                className="flex-1 px-4 py-2 text-sm border rounded-xs border-quinary-default text-quinary-default hover:bg-quinary-default hover:text-ui-on-overlay transition-colors"
            >
                {t('delete.confirm')}
            </button>
        </div>
