                        ...
                        {images.map((src, i) => (
                            <div key={src} className="relative inline-block">
                                ...
                                <button
                                    ...
                                    className="absolute right-0 top-0 cursor-pointer rounded-bl-xs rounded-tr-xs bg-ui-danger px-1.5 py-0.5 text-xs text-ui-on-overlay opacity-75 hover:opacity-100"
                                >
                                    {t('edit.removeImage')}
                                </button>
                            </div>
                ...
                <div className="flex items-stretch justify-between p-2 border-t border-t-tertiary">
                    ...
                    <div className="flex gap-2">
                        ...
                        <button
                            type="button"
                            onClick={handleSave}
                            className="px-4 py-2 text-sm text-ui-on-overlay border rounded-xs bg-primary border-primary hover:bg-primary/80 transition-colors cursor-pointer"
                        >
                            {t('edit.save')}
                        </button>
                    </div>
