    ...
    return (
        <div className="reader-shell" data-bg={r.bg}>
            <main aria-label={t('reader.readerLandmarkAria')}>
                ...
                {isPreview && (
                    <div className="pointer-events-none fixed left-1/2 top-16 z-20 -translate-x-1/2 rounded-ui-full border border-ui-accent-50 bg-ui-accent-25 px-4 py-1.5 text-ui-tiny font-ui-bold uppercase tracking-mr text-ui-accent-fg">
