        ...
        return (
            <div className="flex flex-col gap-3">
                <div className="flex flex-col items-center gap-4 py-12 text-center">
                    ...
                    <div>
                        <h3 className="text-[18px] font-ui-extrabold text-ui-fg">{t('reviews.empty.title')}</h3>
                        <p className="mt-1 text-[14px] text-ui-fg-muted">{t('reviews.empty.desc')}</p>
                    </div>
                    {isLoggedIn && (
        ...
        return (
            <div className="flex flex-col gap-3">
                <div className="flex flex-col items-center gap-3 py-8 text-center">
                    <p className="text-[15px] font-ui-bold text-ui-fg">{t('reviews.empty.noMatch', { star: filterStar })}</p>
                    <button type="button" onClick={onClearFilter} className="text-[13px] font-ui-bold text-ui-accent-fg hover:underline">
