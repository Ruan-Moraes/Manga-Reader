                ...
                <div className="forum-drawer-overlay" onClick={() => setDrawerOpen(false)}>
                    <aside className="forum-drawer" onClick={e => e.stopPropagation()}>
                        <div className="forum-drawer-head">
                            <span className="ui-label" style={{ color: 'var(--ui-accent)' }}>
                                {t('ui.categories')}
                            </span>
                ...
                <main className="forum-main">
                    <div className="forum-header">
                        <div className="forum-header-top">
                            <div>
                                <div className="ui-label" style={{ color: 'var(--ui-accent)', display: 'inline-flex', alignItems: 'center', gap: 6 }}>
                    ...
                    {topics.length === 0 ? (
                        <div className="forum-empty">
                            ...
                            <h3 style={{ color: 'var(--ui-fg)', margin: '10px 0 4px', letterSpacing: '.0625rem' }}>{t('ui.emptyTitle')}</h3>
                            <p style={{ color: 'var(--ui-fg-subtle)', fontSize: 13, marginBottom: 14 }}>{t('ui.emptySub')}</p>
                            <Button variant="primary" icon={Plus} onClick={openCompose}>
                                {t('ui.createTopic')}
                            </Button>
                        </div>
