        ...
        <div className="composer-overlay" onClick={onClose}>
            <div className="composer-shell" onClick={e => e.stopPropagation()}>
                <header className="composer-head">
                    <div>
                        <div className="ui-label" style={{ color: 'var(--ui-accent)', marginBottom: 4, display: 'inline-flex', alignItems: 'center', gap: 6 }}>
                ...
                <div className="composer-body">
                    {step === 'write' ? (
                        <>
                            <div className="composer-row">
                                <label className="composer-label">
                                    <span className="ui-label">{t('ui.categoryLabel')}</span>
                                    <span style={{ fontSize: 11, color: 'var(--ui-fg-subtle)', marginLeft: 8, fontWeight: 400, textTransform: 'none', letterSpacing: 0 }}>{t('ui.categoryHint')}</span>
                                </label>
                            ...
                            <div className="composer-row">
                                <label className="composer-label">
                                    <span className="ui-label">{t('ui.titleLabel')}</span>
                                    <span style={{ fontSize: 11, color: title.length > 120 ? 'var(--ui-danger)' : 'var(--ui-fg-subtle)', marginLeft: 'auto', fontWeight: 700 }}>{title.length}/120</span>
                                </label>
                            ...
                            <div className="composer-row">
                                <label className="composer-label">
                                    <span className="ui-label">{t('ui.tagsLabel')}</span>
                                    <span style={{ fontSize: 11, color: 'var(--ui-fg-subtle)', marginLeft: 8, fontWeight: 400, textTransform: 'none', letterSpacing: 0 }}>{t('ui.tagsHint')}</span>
                                </label>
                            ...
                            <div className="composer-row">
                                <label className="composer-label">
                                    <span className="ui-label">{t('ui.contentLabel')}</span>
                                    <span style={{ fontSize: 11, color: 'var(--ui-fg-subtle)', marginLeft: 8, fontWeight: 400, textTransform: 'none', letterSpacing: 0 }}>
                                        {t('ui.contentHintBefore')} <span style={{ color: 'var(--ui-accent)' }}>[spoiler]</span> {t('ui.contentHintAfter')}
                                    </span>
                                </label>
                                <div className="forum-md-toolbar composer-toolbar">
                                    ...
                                    <span style={{ width: 1, height: 18, background: 'var(--ui-border)', margin: '0 4px' }} />
                                    <button type="button" title={t('ui.spoiler')} className="forum-md-spoiler">
                                        <Eye size={12} strokeWidth={2} />
                                        {t('ui.spoiler')}
                                    </button>
                                    <span style={{ flex: 1 }} />
                                    <span style={{ fontSize: 10, color: 'var(--ui-tertiary)', fontWeight: 700, letterSpacing: '.08em', textTransform: 'uppercase' }}>{t('ui.charCount', { count: body.length })}</span>
                                </div>
                                ...
                                <div className={`composer-drop ${drag ? 'dragging' : ''}`} onDragOver={e => { e.preventDefault(); setDrag(true); }} onDragLeave={() => setDrag(false)} onDrop={onDrop}>
                                    ...
                                    <div>
                                        <div style={{ color: 'var(--ui-fg)', fontSize: 13, fontWeight: 700, letterSpacing: '.0625rem' }}>{t('ui.dropTitle')}</div>
                                        <div style={{ color: 'var(--ui-fg-subtle)', fontSize: 11, marginTop: 2 }}>{t('ui.dropHint')}</div>
                                    </div>
                            ...
                            <div className="composer-row">
                                <label className="composer-label">
                                    <span className="ui-label">{t('ui.optionsLabel')}</span>
                                </label>
                        ...
                        <div className="composer-preview">
                            ...
                            <h1 className="forum-topic-title">{title || <span style={{ color: 'var(--ui-tertiary)' }}>{t('ui.previewTitlePlaceholder')}</span>}</h1>
                            ...
                            <div className="forum-topic-author">
                                <div className="forum-topic-author-block">
                                    <SquareAvatar initials="RM" color="var(--ui-accent)" size={42} />
                                    <div>
                                        <span style={{ color: 'var(--ui-fg)', fontWeight: 800, fontSize: 14, letterSpacing: '.0625rem' }}>Ruan Moraes</span>
                                        <div style={{ color: 'var(--ui-fg-subtle)', fontSize: 11, marginTop: 2 }}>@ruanmoraes · {t('ui.levelShort', { level: 18 })}</div>
                                    </div>
                                </div>
                            </div>
                            <div className="forum-topic-content" style={{ marginTop: 18 }}>
                                {body ? <RichBody text={body} /> : <p style={{ color: 'var(--ui-tertiary)', fontStyle: 'italic' }}>{t('ui.previewBodyPlaceholder')}</p>}
                            </div>
                        </div>
                    )}
                </div>
