...
export const FORUM_USERS: Record<string, ForumUser> = {
    ak: { id: 'ak', name: 'AkariReads', handle: 'akarireads', initials: 'AK', color: 'var(--ui-accent)', level: 42, badge: 'Top Reader', role: null },
    kj: { id: 'kj', name: 'Kenji_99', handle: 'kenji99', initials: 'KJ', color: 'var(--ui-danger)', level: 28, badge: null, role: null },
    yl: { id: 'yl', name: 'YukiLove', handle: 'yukilove', initials: 'YL', color: 'var(--ui-fg-muted)', level: 35, badge: 'Postador', role: null },
    rm: { id: 'rm', name: 'Ruan Moraes', handle: 'ruanmoraes', initials: 'RM', color: 'var(--ui-accent)', level: 18, badge: null, role: 'admin' },
