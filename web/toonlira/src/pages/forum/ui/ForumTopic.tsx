            ...
            <div className="forum-layout forum-layout-topic">
                <main className="forum-main">
                    <div className="forum-crumbs">
                        ...
                        <span style={{ color: 'var(--ui-fg-subtle)' }}>{cat?.label}</span>
                        <ChevronRight size={11} strokeWidth={2} />
                        <span style={{ color: 'var(--ui-accent)' }}>{t('ui.topicNumber', { n: topic.id.replace('t', '') })}</span>
                    </div>
                            ...
                            <div className="forum-topic-author-block">
                                ...
                                <div>
                                    <div style={{ display: 'flex', alignItems: 'center', gap: 6, flexWrap: 'wrap' }}>
                                        <span style={{ color: 'var(--ui-fg)', fontWeight: 800, fontSize: 14, letterSpacing: '.0625rem' }}>{author.name}</span>
                                        {author.badge && <span className="forum-user-badge">{author.badge}</span>}
                                    </div>
                                    <div style={{ color: 'var(--ui-fg-subtle)', fontSize: 11, marginTop: 2 }}>
                    ...
                    <div className="forum-comments-head">
                        ...
                        <div className="forum-comments-sort">
                            <span className="ui-label" style={{ color: 'var(--ui-tertiary)' }}>
                                {t('ui.sortBy')}
                            </span>
                            <Select
                                className="w-44"
