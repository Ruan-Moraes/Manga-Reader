    ...
    return (
        <nav className="forum-cats">
            ...
            <div className="forum-cats-foot">
                <div className="ui-label" style={{ color: 'var(--ui-tertiary)', marginBottom: 6 }}>
                    {t('ui.rules')}
                </div>
                <p style={{ fontSize: 11, color: 'var(--ui-fg-subtle)', lineHeight: 1.5, margin: 0 }}>
                    {t('ui.rulesBefore')} <span style={{ color: 'var(--ui-danger)', fontWeight: 700 }}>[spoiler]</span> {t('ui.rulesAfter')}
                </p>
            </div>
        </nav>
    );
