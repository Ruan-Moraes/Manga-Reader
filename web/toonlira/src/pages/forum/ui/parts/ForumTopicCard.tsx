                    ...
                    <div className="forum-card-footer">
                        ...
                        <div className="forum-last-reply" onClick={e => e.stopPropagation()}>
                            ...
                            <div className="forum-last-reply-line">
                                ...
                                <span style={{ color: 'var(--ui-fg)', fontWeight: 700, fontSize: 12, letterSpacing: '.0625rem' }}>{last.name}</span>
                                <span style={{ color: 'var(--ui-fg-subtle)', fontSize: 11 }}>· {topic.lastReplyAt}</span>
                            </div>
                        </div>
                    </div>
                </div>
