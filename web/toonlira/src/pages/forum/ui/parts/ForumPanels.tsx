                    ...
                    <li key={tp.id} onClick={() => onOpenTopic(tp.id)}>
                        ...
                        <div style={{ flex: 1, minWidth: 0 }}>
                            ...
                            <div className="forum-trending-meta">
                                ...
                                <span style={{ color: 'var(--ui-accent)', fontWeight: 800 }}>· {tp.trend}</span>
                            </div>
                        </div>
                    </li>
                ))}
                        ...
                        <li key={i} onClick={() => onOpenTopic(c.topicId)}>
                            ...
                            <div style={{ flex: 1, minWidth: 0 }}>
                                <div className="forum-recent-head">
                                    <span style={{ color: 'var(--ui-fg)', fontWeight: 700, fontSize: 12, letterSpacing: '.0625rem' }}>{u.name}</span>
                                    <span style={{ color: 'var(--ui-tertiary)', fontSize: 11 }}>· {c.when}</span>
                                </div>
                                <div className="forum-recent-text">{c.text}</div>
                                <div className="forum-recent-on">
                                    {t('ui.commentOn')} <span style={{ color: 'var(--ui-accent)' }}>{tp?.title}</span>
                                </div>
                            </div>
                        </li>
                    );
