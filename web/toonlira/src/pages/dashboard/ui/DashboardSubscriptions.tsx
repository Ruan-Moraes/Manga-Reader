...
const DashboardSubscriptions = () => {
    ...
    return (
        <div className="flex flex-col gap-4">
            <div>
                <h1 className="text-[26px] font-ui-extrabold leading-tight text-ui-fg md:text-[30px]">{t('dashboard.subscriptions.title')}</h1>
                <p className="mt-1.5 text-ui-small text-ui-fg-subtle">{t('dashboard.subscriptions.subtitle')}</p>
            </div>
            ...
            {isLoadingSummary ? (
                ...
                <p className="text-ui-small text-ui-fg-subtle">{t('dashboard.subscriptions.errorSummary')}</p>
            ) : (
