    ...
    return (
        <div className="flex min-h-screen flex-col">
            ...
            <main className="flex flex-1 flex-col items-center justify-center gap-4 p-8">
                <h1 className="text-ui-h2 font-ui-extrabold">Chrome Test Bed</h1>
                <p className="text-ui-fg-muted">NavBar + SideMenu + MobileTabBar + Footer</p>
                <p className="text-ui-small text-ui-fg-subtle">
