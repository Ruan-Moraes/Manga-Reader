        ...
        <>
            ...
            <Section title="Card">
                <SubSection label="Variantes">
                    <Card variant="default" className="w-40 text-center text-ui-small">
                        Default
                    </Card>
                    <Card variant="flat" className="w-40 text-center text-ui-small">
                        Flat
                    </Card>
                    <Card variant="elevated" className="w-40 text-center text-ui-small">
                        Elevated
                    </Card>
                </SubSection>
                <SubSection label="Padding">
                    <Card padding="none" className="border border-ui-border-subtle text-ui-tiny">
                        none
                    </Card>
                    <Card padding="sm" className="text-ui-tiny">
                        sm
                    </Card>
                    <Card padding="md" className="text-ui-tiny">
                        md (padrão)
                    </Card>
                    <Card padding="lg" className="text-ui-tiny">
                        lg
                    </Card>
                </SubSection>
                <SubSection label="Interativo (hover)">
                    <Card interactive className="w-40 text-center text-ui-small">
                        Passe o mouse
                    </Card>
                </SubSection>
            </Section>
            ...
            <Section title="ProgressBar">
                <SubSection label="Valores e espessuras">
                    <div className="flex w-full flex-col gap-4">
                        <div>
                            <p className="mb-1 text-ui-tiny text-ui-fg-muted">Thin 30%</p>
                            <ProgressBar value={30} label="30% concluído" />
                        </div>
                        <div>
                            <p className="mb-1 text-ui-tiny text-ui-fg-muted">Thin 75%</p>
                            <ProgressBar value={75} label="75% concluído" />
                        </div>
                        <div>
                            <p className="mb-1 text-ui-tiny text-ui-fg-muted">Thick 60%</p>
                            <ProgressBar value={60} thickness="thick" label="60% concluído" />
                        </div>
                        <div>
                            <p className="mb-1 text-ui-tiny text-ui-fg-muted">Danger 40%</p>
                            <ProgressBar value={40} tone="danger" label="40%" />
                        </div>
                        <div>
                            <p className="mb-1 text-ui-tiny text-ui-fg-muted">Indeterminado</p>
            ...
            <Section title="StatusDot">
                <SubSection label="Estados">
                    <div className="flex items-center gap-4">
                        <span className="flex items-center gap-2 text-ui-small">
            ...
            <Section title="Tabs">
                <SubSection label="Underline (padrão)">
                    <div className="w-full">
                        ...
                        />
                        <div className="mt-4 text-ui-small text-ui-fg-muted">
                            Aba ativa: <span className="text-ui-accent-fg">{activeTab}</span>
                        </div>
                    </div>
                </SubSection>
            ...
            <Section title="Modal">
                <SubSection label="Dialog nativo com foco trap">
                    ...
                    >
                        <p className="text-ui-body text-ui-fg-muted">
                ...
                <SubSection label="Slide da direita">
                    ...
                    >
                        <div className="flex flex-col gap-4">
                            <p className="text-ui-small text-ui-fg-muted">Conteúdo do drawer. Feche com Esc ou clicando no overlay.</p>
