...
export default function PrimitivesSection() {
    ...
    return (
        <>
            <h1 className="mb-2 text-ui-h1">Design System — Primitivos</h1>
            <p className="mb-10 text-ui-fg-muted">Fase 1 — QA visual de componentes base</p>
            ...
            <Section title="Icon">
                ...
                <SubSection label="Colorido (className)">
                    <Icon icon={Heart} size={24} className="text-ui-accent-fg" />
                    <Icon icon={Eye} size={24} className="text-ui-fg-muted" />
                    <Icon icon={Bell} size={24} className="text-ui-danger" />
                    <Icon icon={Bookmark} size={24} className="text-ui-fg" />
                </SubSection>
            </Section>
            ...
            <Section title="Stars">
                ...
                <SubSection label="Input interativo">
                    <div className="flex items-center gap-4">
                        ...
                        <span className="text-ui-fg-muted text-ui-small">{rating} / 5</span>
                        <button type="button" className="text-ui-tiny text-ui-fg-muted underline" onClick={() => setRating(0)}>
                            Limpar
                        </button>
                    </div>
                </SubSection>
            ...
            <Section title="Switch">
                ...
                <SubSection label="Estado atual">
                    <span className="text-ui-small text-ui-fg-muted">
