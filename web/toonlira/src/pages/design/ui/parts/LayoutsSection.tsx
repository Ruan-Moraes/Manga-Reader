        ...
        <>
            ...
            <Section title="NavBar">
                <SubSection label="Com usuário logado (sticky acima)">
                    <div className="w-full -mx-6 border border-ui-border-subtle">
                        <NavBar
                            links={NAV_LINKS}
                            user={DEMO_USER}
                    ...
                    <div className="flex w-full flex-col gap-2">
                        {(['narrow', 'default', 'wide'] as const).map(s => (
                            <PageContainer
                                ...
                                size={s}
                                paddingY="sm"
                                className="border border-dashed border-ui-accent-50 text-ui-tiny text-ui-fg-muted text-center"
                            >
                                size=&quot;{s}&quot;
                            </PageContainer>
                        ))}
                ...
                <SubSection label="Com visual (poster) + ações">
                    <div className="w-full">
                        <HeroSection
                            ...
                            visual={
                                <div className="h-40 w-28 rounded-ui-sm bg-ui-gray-800 flex items-center justify-center text-ui-tiny text-ui-fg-muted">
                                    capa
                                </div>
                            }
                        />
            ...
            <Section title="MobileTabBar">
                <SubSection label="Preview (fixo em viewport real — visível em &lt;768px)">
                    <p className="text-ui-small text-ui-fg-muted">Visível apenas em mobile. Redimensione a janela para &lt;768px para ver.</p>
                    <MobileTabBar
                        activeKey={activeNavKey}
                        items={[
                            {
