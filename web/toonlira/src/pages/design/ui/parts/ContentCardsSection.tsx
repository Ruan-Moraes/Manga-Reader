        ...
        <>
            ...
            <Section title="ChapterListItem">
                <SubSection label="Estados: lido, atual, com group">
                    <div className="w-full rounded-ui-xs border border-ui-border overflow-hidden">
                        <ChapterListItem
                            number={1120}
                    ...
                    <div className="flex w-full flex-col gap-3">
                        <ReviewCard
                            ...
                            manga={{
                                id: '1',
                                title: 'Berserk',
                                gradient: 'var(--ui-poster-gradient)',
                            }}
                            upvotes={247}
                            myVote="up"
                            badge="top"
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 w-full">
                        <EventCard
                            event={{
                                ...
                                special: true,
                                going: false,
                                coverGradient: 'var(--ui-poster-gradient)',
                            }}
                            onToggleGoing={() => {}}
                            onClick={() => {}}
                        />
            ...
            <Section title="Paleta de tokens">
                <SubSection label="Cores">
                    {[
                        ['ui-primary', 'bg-ui-primary'],
                        ['ui-secondary', 'bg-ui-secondary'],
                        ['ui-tertiary', 'bg-ui-tertiary'],
                        ['ui-accent', 'bg-ui-accent'],
                        ['ui-danger', 'bg-ui-danger'],
                        ['ui-gray-900', 'bg-ui-gray-900'],
                        ['ui-gray-800', 'bg-ui-gray-800'],
                        ['ui-gray-700', 'bg-ui-gray-700'],
                        ['ui-gray-500', 'bg-ui-gray-500'],
                        ['ui-gray-300', 'bg-ui-gray-300'],
                    ].map(([label, cls]) => (
                        <div key={label} className="flex flex-col items-center gap-1">
                            <div className={`size-10 rounded-ui-xs border border-ui-gray-700 ${cls}`} />
                ...
                <SubSection label="Tipografia">
                    <div className="flex w-full flex-col gap-2">
                        <p className="text-ui-h1">H1 — Nunito Sans ExtraBold</p>
                        <p className="text-ui-h2">H2 — Nunito Sans ExtraBold</p>
                        <p className="text-ui-h3">H3 — Nunito Sans Bold</p>
                        <p className="text-ui-h4">H4 — Nunito Sans Bold</p>
                        <p className="text-ui-body">Body — Nunito Sans Regular (14px / 1.55)</p>
                        <p className="text-ui-small">Small — 12px / 1.4</p>
                        <p className="text-ui-tiny">Tiny — 11px / 1.3</p>
                    </div>
                </SubSection>
                <SubSection label="Sombras">
                    <div className="flex gap-6">
                        <div className="rounded-ui-sm bg-ui-secondary p-4 shadow-ui-default text-ui-small">shadow-ui-default</div>
                        <div className="rounded-ui-sm bg-ui-secondary p-4 shadow-ui-elevated text-ui-small">shadow-ui-elevated</div>
                        <div className="rounded-ui-sm bg-ui-secondary p-4 shadow-ui-overlay text-ui-small">shadow-ui-overlay</div>
                    </div>
                </SubSection>
            </Section>
        </>
