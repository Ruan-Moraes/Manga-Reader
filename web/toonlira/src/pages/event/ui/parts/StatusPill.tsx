...
const MAP: Record<EventLiveStatus, { key: string; bg: string; fg: string; dot: string; glow: boolean }> = {
    active: { key: 'statusActive', bg: 'var(--ui-accent-10)', fg: 'var(--ui-accent-fg)', dot: 'var(--ui-accent)', glow: true },
    upcoming: { key: 'statusUpcoming', bg: 'var(--ui-surface-elevated)', fg: 'var(--ui-fg-muted)', dot: 'var(--ui-fg-subtle)', glow: false },
    ended: { key: 'statusEnded', bg: 'var(--ui-surface-elevated)', fg: 'var(--ui-fg-disabled)', dot: 'var(--ui-fg-disabled)', glow: false },
};
