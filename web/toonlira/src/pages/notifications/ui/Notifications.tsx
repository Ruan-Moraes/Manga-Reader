    ...
    return (
        <PageContainer asMain size="default" paddingY="md">
            ...
            <div className="flex flex-col items-center gap-4 py-12 text-center">
                ...
                <div>
                    <h2 className="text-[18px] font-ui-extrabold text-ui-fg">{t('notifications.emptyState')}</h2>
                    <p className="mt-1 text-ui-body text-ui-fg-muted">{t('notifications.emptyDesc')}</p>
                </div>
            </div>
        </PageContainer>
    );
