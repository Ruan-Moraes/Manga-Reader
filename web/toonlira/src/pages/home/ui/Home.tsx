...
const Home = () => {
    ...
    return (
        <PageContainer asMain paddingY="md">
            <a
                href="#main-content"
                className="sr-only focus:not-sr-only focus:fixed focus:top-4 focus:left-4 focus:z-50 focus:rounded focus:bg-ui-accent focus:px-3 focus:py-1 focus:text-ui-on-accent"
            >
                {t('skipToContent')}
            </a>
