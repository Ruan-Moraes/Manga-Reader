        ...
        <LegalShell page="privacy" title={t('privacy.title')} sub={t('privacy.sub')} updated={t('privacy.updated')} version={t('privacy.version')} toc={toc}>
                ...
                <dl className="mt-3 grid grid-cols-1 gap-2 sm:grid-cols-2">
                    {coletaRows.map(row => (
                        <div key={row.term} className="rounded-ui-sm border border-ui-border bg-ui-surface p-3">
                            ...
                            <dd className="mt-1 text-ui-small text-ui-fg-muted">{row.value}</dd>
                        </div>
                    ))}
                </dl>
            </LegalSection>
            ...
            <LegalSection id="direitos" num={7} title={t('privacy.sections.direitos.title')}>
                ...
                <p className="mt-3">
                    <Trans
                        ...
                        ns="legal"
                        components={{
                            mail: <a href={`mailto:${privacyContact}`} className="text-ui-accent-fg underline hover:no-underline" />,
                        }}
                    />
                </p>
            </LegalSection>
            ...
            <Card variant="flat" className="mt-8 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                <div className="min-w-0">
                    <p className="text-ui-body font-ui-extrabold text-ui-fg">{t('privacy.footerCard.title')}</p>
                    <p className="text-ui-small text-ui-fg-muted">{t('privacy.footerCard.desc')}</p>
                </div>
