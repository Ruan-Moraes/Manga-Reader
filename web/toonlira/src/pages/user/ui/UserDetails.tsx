                    ...
                    <div className="space-y-3">
                        ...
                        <div className="p-3 border rounded-xs border-tertiary bg-secondary/40">
                            ...
                            <ul className="space-y-1 text-xs text-tertiary">
                                <li>
                                    <span className="font-semibold text-ui-fg">{t('details.roleLabel')}</span> {roleLabel}
                                </li>
                                {targetUser.member?.isMember && (
                                    <li>
                                        <span className="font-semibold text-ui-fg">{t('details.memberSince')}</span>{' '}
                                        {formatDate(targetUser.member.since, dateOptions)}
                                    </li>
                                )}
                                {targetUser.moderator?.isModerator && (
                                    <li>
                                        <span className="font-semibold text-ui-fg">{t('details.moderatorSince')}</span>{' '}
