    ...
    return (
        <PageContainer asMain size="narrow" paddingY="md">
            ...
            <Card variant="default" className="mb-6 p-6">
                <p className="mb-3 leading-relaxed text-ui-small text-ui-fg-muted">{t('publishWork.description1')}</p>
                <p className="leading-relaxed text-ui-small text-ui-fg-muted">{t('publishWork.description2')}</p>
            </Card>
