                ...
                <section className="mb-12">
                    <Card variant="flat" className="flex flex-col items-center gap-4 py-8 text-center sm:flex-row sm:text-left sm:py-6">
                        ...
                        <div className="flex-1">
                            <p className="ui-label mb-1 text-ui-accent-fg">{t('contact.eyebrow')}</p>
                            <h3 className="text-ui-h3 font-ui-extrabold tracking-mr text-ui-fg">{t('contact.title')}</h3>
                            <p className="mt-1 text-ui-small text-ui-fg-muted">
                                {t('contact.responseTime')} <strong className="text-ui-fg">{t('contact.responseTimeValue')}</strong>
                            </p>
                        </div>
