        ...
        <div className="flex flex-col gap-3">
            {items.map(m => (
                <button
                    ...
                    type="button"
                    onClick={() => onNavigate(m.id)}
                    className="flex items-center gap-3 rounded-ui-md border border-ui-border bg-ui-surface px-4 py-3 text-left shadow-ui-elevated transition-colors hover:border-ui-accent-border"
                >
                    <div
                    ...
                    <div className="flex-1 min-w-0">
                        ...
                        <p className="text-ui-tiny text-ui-fg-muted">{m.author}</p>
                    </div>
