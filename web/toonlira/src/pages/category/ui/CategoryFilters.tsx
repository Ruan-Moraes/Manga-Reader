...
const CategoryFilters = () => {
    ...
    return (
        <PageContainer asMain size="default" paddingY="md">
            <section className="mb-5 rounded-ui-md border border-ui-border bg-ui-surface px-4 py-4 shadow-ui-elevated sm:mb-6 sm:px-6 sm:py-5">
                <div className="flex items-end justify-between gap-4">
                    <div className="min-w-0">
                        <p className="ui-label mb-1 text-ui-fg-subtle">{t('filters.eyebrow')}</p>
                        <h2 className="m-0 text-ui-h2 font-ui-extrabold leading-tight tracking-mr text-ui-fg">{t('filters.title')}</h2>
                    </div>
                    <span className="shrink-0 rounded-ui-full border border-ui-accent-border bg-ui-accent/10 px-3 py-1 text-ui-tiny font-ui-bold text-ui-accent-fg">
            ...
            <div className="flex items-start gap-5 xl:gap-6">
                ...
                <div className="flex-1 min-w-0">
                    ...
                    <section className="mb-5 rounded-ui-md border border-ui-border bg-ui-surface p-3 shadow-ui-elevated sm:p-4" aria-label={t('filters.resultsControlsAria')}>
                        ...
                        {activeFilters.length > 0 && (
                            <div className="mt-3 flex flex-wrap items-center gap-2 border-t border-ui-border pt-3" aria-live="polite">
                                <span className="ui-label text-ui-fg-subtle">{t('filters.activeFilters')}</span>
                                ...
                                <button
                                    ...
                                    className="inline-flex items-center gap-1 rounded-ui-full border border-ui-accent-border bg-ui-accent/10 px-3 py-1 text-ui-tiny text-ui-accent-fg transition-colors hover:bg-ui-accent/20"
                                >
                                    {filter.label}
                                    <X className="size-3" />
                                </button>
