    ...
    <div className="flex flex-wrap items-center gap-2">
        ...
        {onReply && (
            <button
                ...
                className="inline-flex h-8 items-center gap-1.5 rounded-ui-full border border-ui-chip-border bg-ui-chip px-[13px] text-[12.5px] font-ui-bold text-ui-fg-subtle transition-all hover:border-ui-accent-50 hover:text-ui-fg ui-focus-ring max-md:w-8 max-md:justify-center max-md:gap-0 max-md:px-0"
            >
