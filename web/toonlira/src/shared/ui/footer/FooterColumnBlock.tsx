...
export const FooterColumnBlock = ({
    ...
    <div className="border-b border-ui-gray-800 md:border-none">
        <button
            type="button"
            onClick={onToggle}
        ...
        >
            <span className="text-xs font-ui-extrabold uppercase tracking-[0.1rem] pb-[0.125rem] md:border-b border-ui-tertiary">{column.title}</span>
            <ChevronDown
                aria-hidden="true"
                className="size-4 text-ui-fg-subtle transition-transform duration-200"
