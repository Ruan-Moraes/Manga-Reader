...
describe('Footer', () => {
    ...
    it('renders provided copyright', () => {
        render(<Footer columns={columns} copyright="© 2025 Toonlira" />);
        expect(screen.getByText(/© 2025 toonlira/i)).toBeInTheDocument();
    });

    it('renders default copyright when not provided', () => {
        render(<Footer columns={columns} />);
        expect(screen.getByText(/toonlira/i)).toBeInTheDocument();
    });
