...
describe('Input', () => {
    ...
    it('disabled passa pro input nativo', () => {
        ...
        expect(input).toHaveClass('text-ui-fg-disabled', 'placeholder:text-ui-fg-disabled');
        expect(input.parentElement).toHaveClass('bg-ui-surface-muted', 'border-ui-border-subtle');
    });
});
