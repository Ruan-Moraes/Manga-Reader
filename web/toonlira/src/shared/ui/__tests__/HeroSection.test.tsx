...
describe('HeroSection', () => {
    ...
    it('renders eyebrow when provided', () => {
        ...
        expect(screen.getByText('Em alta')).toHaveClass('text-ui-accent');
    });
    ...
    it('uses the shared poster background token', () => {
        ...
        expect(section.style.background).toBe('var(--ui-poster-gradient)');
        expect(screen.getByRole('heading', { name: 'Título' }).parentElement).toHaveClass('text-ui-on-overlay');
    });
