...
describe('Switch', () => {
    ...
    it('usa cores semânticas próprias no track desabilitado', () => {
        ...
        expect(track).toHaveClass('bg-ui-surface-muted', 'border-ui-border-subtle');
        expect(track?.firstElementChild).toHaveClass('bg-ui-fg-disabled');
    });
    ...
    it('usa tokens próprios no estado desligado', () => {
        ...
        expect(track).toHaveClass('bg-ui-control-track-off');
        expect(track?.firstElementChild).toHaveClass('bg-ui-control-thumb-off');
    });
});
