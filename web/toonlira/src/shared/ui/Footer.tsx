...
export const Footer = ({ columns, onSubscribe, copyright, apps, socials, preferenceItems, preferences, onBrandNavigate, texts }: FooterProps) => {
    ...
    return (
        <footer className="border-t border-ui-separator bg-ui-primary tracking-mr">
            <div className="mx-auto max-w-ui-container px-3 pt-8 mobile-md:px-4 sm:px-5 sm:pt-10 lg:px-6">
                <div className="grid gap-4 md:gap-10 lg:grid-cols-[minmax(300px,1fr)_2fr]">
                    <div className="flex min-w-0 flex-col gap-2">
                        <Logo onNavigate={onBrandNavigate} />
                        <p className="text-sm leading-relaxed text-ui-fg-subtle mb-4">{t.tagline}</p>
                        ...
                        <div className="hidden lg:block border-t border-ui-border-subtle my-auto" />
                        {socials && socials.length > 0 && (
                            <div className="flex flex-col gap-2 mt-4 lg:mt-0">
                                <span className="block text-xs font-ui-bold uppercase tracking-[0.1rem]">{t.socialsLabel}</span>
                                <div className="flex flex-wrap gap-2">
                                    {socials.map(s => (
                    ...
                    <nav
                        ...
                        className={cn(
                            ...
                            '[&>*]:md:relative [&>*]:md:pl-4',
                            "[&>*]:md:before:absolute [&>*]:md:before:left-0 [&>*]:md:before:top-0 [&>*]:md:before:h-full [&>*]:md:before:w-px [&>*]:md:before:bg-ui-gray-800 [&>*]:md:before:content-['']",
                ...
                <div className="mt-6 flex flex-wrap items-center gap-3 py-[22px] md:border-t border-ui-border-subtle">
                    <div className="text-[12px] text-ui-fg-subtle">
                        {copyright ?? `© ${new Date().getFullYear()} ${brand.name}. Feito por Ruan — projeto de estudo.`}
                    </div>
