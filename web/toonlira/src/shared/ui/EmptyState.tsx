        ...
        >
            {errored || !src ? (
                <div
                    ...
                    className="flex shrink-0 items-center justify-center rounded-2xl bg-ui-surface-muted text-ui-fg-muted"
                >
            ...
            <div className={isHorizontal ? 'flex flex-col items-center gap-2 md:items-start' : 'flex max-w-md flex-col items-center gap-2'}>
                <h3 className="text-ui-h3 font-ui-extrabold text-ui-fg">{title}</h3>
                {description && <p className="text-ui-body text-balance text-ui-fg-muted">{description}</p>}
