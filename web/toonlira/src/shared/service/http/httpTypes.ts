 ...
 *
 * Shape retornado pelo api Spring Boot em **todas** as respostas de sucesso.
...
export type ApiErrorResponse = {
    success: false;
    /** Código técnico do erro (vem do api `ApiErrorCode`). */
    code?: string;
...
/**AUTH_ACCESS_DENIED
 * Wrapper para respostas paginadas — espelho do `PageResponse` do api.
 */
...
export type HttpClientConfig = {
    /** URL base da API (ex.: `https://api.toonlira.com/v1`). */
    baseURL?: string;
