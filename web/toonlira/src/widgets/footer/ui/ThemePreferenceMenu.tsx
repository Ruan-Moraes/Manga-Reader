        ...
        <DropdownMenu
            trigger={
                <button
                    ...
                    className="ui-focus-ring inline-flex min-h-[36px] items-center gap-2 rounded-[2px] border border-ui-gray-700 bg-transparent px-3 py-1.5 text-[12px] font-ui-semibold text-ui-fg-muted transition-colors duration-200 hover:border-ui-accent-border hover:text-ui-accent-fg"
                >
                    <TriggerIcon className="size-[14px]" aria-hidden="true" />
                    <span>{t('footer.preferences.theme', { ns: 'layout' })}</span>
                    <span className="text-ui-fg">{themeLabel(currentTheme)}</span>
