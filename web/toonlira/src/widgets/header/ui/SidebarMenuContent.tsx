...
const sectionTitleClass = 'text-[0.7rem] font-semibold tracking-[0.14em] uppercase text-ui-accent-fg';
            ...
            <div className="flex flex-col gap-2 p-2 mt-auto border bg-secondary rounded-xs border-tertiary">
                ...
                {isLoggedIn && (
                    <button
                        type="button"
                        onClick={onLogout}
                        className="w-full h-10 px-4 text-xs font-semibold border rounded-xs border-quinary-default text-quinary-default bg-primary-default hover:bg-quinary-default hover:text-ui-on-overlay transition-colors duration-300 flex items-center justify-center gap-2"
                    >
