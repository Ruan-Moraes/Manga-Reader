                ...
                return (
                    ...
                    >
                        <button
                            ...
                            aria-haspopup="true"
                            className={cn(
                                'flex items-center gap-[5px] rounded-ui-xs px-3 py-[9px] text-ui-small font-ui-bold text-ui-fg transition-colors duration-ui-default',
                                'hover:bg-ui-accent-25 focus-visible:outline-2 focus-visible:outline-ui-focus-ring focus-visible:outline-offset-2',
                                isOpen && 'bg-ui-accent-25',
                            )}
                        ...
                        >
                            ...
                            <ChevronDown
                                aria-hidden="true"
                                className={cn('size-[15px] opacity-65 transition-transform duration-ui-default', isOpen && 'rotate-180 opacity-100')}
                            />
                        </button>
                        {isOpen && (
                            <>
                                ...
                                <div
                                    ...
                                    onMouseLeave={scheduleClose}
                                    className="absolute left-0 top-[calc(100%+0.5rem)] min-w-[280px] border border-ui-gray-700 bg-ui-secondary p-2"
                                    style={{
                                        borderRadius: 8,
                                    ...
                                    {section.items.map(item => {
                                        ...
                                        return (
                                            <button
                                                ...
                                                className="flex w-full items-center gap-3 rounded-ui-xs p-[10px] text-left text-ui-fg transition-colors duration-ui-default hover:bg-ui-accent-25 focus-visible:outline-2 focus-visible:outline-ui-focus-ring"
                                            >
                                                <span
                                                    className="flex shrink-0 items-center justify-center rounded-ui-xs"
                                                    style={{ width: 34, height: 34, background: 'var(--ui-accent-10)', color: 'var(--ui-accent)' }}
                                                    aria-hidden="true"
                                                >
                                                    <Icon className="size-[18px]" strokeWidth={2} />
                                                </span>
                                                <span className="flex min-w-0 flex-col">
                                                    <span className="text-ui-small font-ui-bold leading-tight" style={{ letterSpacing: '0.0625rem' }}>
                                                        {item.label}
                                                    </span>
                                                    <span className="mt-[2px] text-[12px] leading-tight text-ui-gray-300">{item.hint}</span>
                                                </span>
                                            </button>
                                        );
                                    })}
