    ...
    const footer = isLoggedIn ? (
        <div className="flex flex-col gap-1">
            <button
                ...
                className="flex h-10 items-center gap-3 rounded-ui-xs px-3 text-ui-small font-ui-bold text-ui-fg-muted hover:bg-ui-accent-25 hover:text-ui-fg transition-colors duration-ui-default"
            >
            ...
            <button
                ...
                className="flex h-10 items-center gap-3 rounded-ui-xs px-3 text-ui-small font-ui-bold text-ui-danger hover:bg-ui-danger/10 transition-colors duration-ui-default"
            >
