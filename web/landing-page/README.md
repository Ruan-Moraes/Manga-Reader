...
|---|---|---|
| `VITE_APP_URL` | Destino centralizado dos links para a aplicação principal | `http://localhost:5173` em desenvolvimento e `https://toonlira-rm.firebaseapp.com` em produção |
