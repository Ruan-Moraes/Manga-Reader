...
> Esta skill é o **protocolo de aplicação** das *Database Modeling Guidelines* do `CLAUDE.md`.
...
Postgres→Mongo é `title_id varchar`, **sem FK**. Ver tabela de ownership no `CLAUDE.md`.
