...
import GroupHeader from '../../components/cards/groups/GroupHeader';
import MemberModal from '../../components/modals/groups/MemberModal';
                        ...
                        <section className="flex flex-col gap-3">
                            ...
                            <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-4">
                                {sortedWorks.map(work => (
                                    <a
                                        key={work.id}
                                        href={`/Manga-Reader/titles/${work.id}`}
